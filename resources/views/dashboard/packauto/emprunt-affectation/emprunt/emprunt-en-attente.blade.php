            ...
            <div class="page-header">
                <div class="row align-items-center mb-3">
                    <div class="col-sm mb-2 mb-sm-0">
                        <h1 class="page-header-title">Nombre d'emprunt de véhicules en attente de validation <span class="badge bg-soft-dark text-dark ms-2">{{ $paffectations->count() }}</span></h1>
                    </div>
                    ...
                    <div class="col-auto col-sm-12 col-md-6 text-end">
                        ...
                        <a class="btn btn-light m-1" href="{{ route('packauto.emprunt.general') }}">
                            <i class="bi-printer me-1"></i> Emprunts en cours
                        </a>
                    </div>
                ...
                <div class="js-nav-scroller hs-nav-scroller-horizontal">
                    ...
                    <ul class="nav nav-tabs page-header-tabs" id="pageHeaderTab" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('packauto.emprunt.general') }}" tabindex="-1" aria-disabled="true">
                                Tout les emprunts
                                <!-- <span class="badge bg-soft-dark text-dark rounded-pill ms-1">{{ $paffectations->count() }}</span> -->
                            </a>
                        </li>
                                            ...
                                            <div class="btn-group" role="group">
                                                ...
                                                <div class="btn-group">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-top mt-1" aria-labelledby="productsEditDrop{{ $paffectation->id }}down">                
                                                        ...
                                                        <a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#ApprouverAffectation{{ $paffectation->id }}">
                                                            <i class="bi-printer dropdown-item-icon"></i>Approuver l'emprunt
                                                        </a>
