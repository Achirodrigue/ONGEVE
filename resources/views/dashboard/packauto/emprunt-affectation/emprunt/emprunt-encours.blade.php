                ...
                <div class="row align-items-center mb-3">
                    ...
                    <div class="col-auto col-sm-12 col-md-6 text-end">
                        ...
                        <a class="btn btn-light m-1" href="{{ route('packauto.emprunt.general') }}">
                            <i class="bi-printer me-1"></i> Historique des emprunts
                        </a>
                    </div>
                                            ...
                                            <div class="btn-group" role="group">
                                                ...
                                                <div class="btn-group">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-top mt-1" aria-labelledby="productsEditDrop{{ $paffectation->id }}down">                
                                                        ...
                                                        <a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#CloturerAffectation{{ $paffectation->id }}">
                                                            <i class="bi-printer dropdown-item-icon"></i>Cloturer l'emprunt
                                                        </a>
