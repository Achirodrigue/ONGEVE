            ...
            <div class="page-header">
                <div class="row align-items-center mb-3">
                    <div class="col-sm mb-2 mb-sm-0">
                        <h1 class="page-header-title">Nombre de véhicules en cours d'emprunt sur la plateforme <span class="badge bg-soft-dark text-dark ms-2">{{ $pvehicules->count() }}</span></h1>
                    </div>
            ...
            <div class="card card-table">
                ...
                @else
                    ...
                    <div class="card-header card-header-content-md-between p-4">
                        <h3 class="fw-bold mb-0 text-center">Désolé! Aucun véhicule n'est en cours d'emprunt sur la plateforme</h3>
                    </div>
                    <!-- End Header -->
                @endif
            </div>
