...
@section('body')
    ...
    <div id="container">
      <div class="page-header">
        <div class="row align-items-center mb-3">
          <div class="col-auto">
            <h1>QR Code de panne général pour tout les véhicules</h1>
          </div>
        </div>
      </div>
    ...
    <script>
      ...
      document.getElementById("download-pdf").addEventListener("click", () => {
        ...
        doc.text("Formulaire de panne des véhicules", pageWidth / 2, y - 10, { align: "center" });
        doc.addImage(imgData, "PNG", x, y, imgWidth, imgHeight);
        doc.save("formulaire_panne_vehicule.pdf");
      });
