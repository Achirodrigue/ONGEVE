...
@section('body')
    ...
    <div id="container">
      <div class="page-header">
        <div class="row align-items-center mb-3">
          <div class="col-auto">
            <h1>QR Code d'emprunt du véhicule <span class="text-danger">{{ $pvehicule->marque }}</span></h1>
          </div>
        </div>
      </div>
    ...
    <script>
      const urlFormulaire = "{{ route('commun.emprunt.vehicule', $pvehicule) }}";
      ...
      document.getElementById("download-pdf").addEventListener("click", () => {
        ...
        doc.text("Formulaire d'emprunt du véhicule {{ $pvehicule->marque }}", pageWidth / 2, y - 10, { align: "center" });
        doc.addImage(imgData, "PNG", x, y, imgWidth, imgHeight);
        doc.save("formulaire_emprunt_vehicule_{{ $pvehicule->marque }}.pdf");
      });
