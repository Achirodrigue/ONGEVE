            ...
            <div class="page-header">
                <div class="row align-items-center mb-3">
                    <div class="col-sm mb-2 mb-sm-0">
                        <h1 class="page-header-title">Nombre de panne entretenu <span class="badge bg-soft-dark text-dark ms-2">{{ $ppannes->count() }}</span></h1>
                    </div>
                ...
                <div class="js-nav-scroller hs-nav-scroller-horizontal">
                    ...
                    <ul class="nav nav-tabs page-header-tabs" id="pageHeaderTab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('packauto.panne.encours') }}" tabindex="-1" aria-disabled="true">
                            ...
                            <tbody>
                                ...
                                @foreach($ppannes as $ppanne)
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center fw-bold">
                                            <div class="btn-group" role="group">
                                                <a class="btn btn-white btn-sm" href="#" data-bs-toggle="modal" data-bs-target="#infoEntretien{{ $ppanne->id }}">
                                                    <i class="bi-eye me-1"></i> Infos
                                                </a>
                                            </div>
                                        </td>
                                            ...
                                            <div class="btn-group" role="group">
                                                ...
                                                <div class="btn-group">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-top mt-1" aria-labelledby="productsEditDrop{{ $ppanne->id }}down">                
                                                        ...
                                                        <a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#editAttesterEntretienPanne{{ $ppanne->id }}">
                                                            <i class="bi-printer dropdown-item-icon"></i>Modifier l'attestation
                                                        </a>
