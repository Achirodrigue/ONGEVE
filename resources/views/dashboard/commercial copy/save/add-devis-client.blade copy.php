                          ...
                          <tr>
                            <th scope="col" class="table-column-pe-0">
                              <div class="form-check">
                                <input class="form-check-input" type="radio" value="" id="datatableCheckAll">
                          ...
                          @foreach(clients() as $client)
                            <tr>
                              <td class="table-column-pe-0">
                                <div class="form-check">
                                  <input class="form-check-input" type="radio" name="client" value="{{ $client->id }}" id="datatableCheckAll1">
              ...
              <div class="card mb-3 mb-lg-5">
                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col-sm-12">
                      <div class="mb-4">
                        <label for="categoryLabel" class="form-label">Nouveau Particulier / Encien</label>
                        <div class="tom-select-custom">
