                ...
                <tbody>
                  @foreach($clients as $client)
                    <tr>
                      ...
                      <td class="fw-bold">{{ $client->genre }}</td>
                      <td class="fw-bold">{{ $client->naissance }}</td>
                        ...
                        <div class="btn-group" role="group">
                          ...
                          <div class="btn-group">
                            ...
                            <div class="dropdown-menu dropdown-menu-end mt-1" aria-labelledby="productsEditDropdown1">
                              <a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#deleteClient{{ $client->id }}">
                      ...
                      <td>
                        <div class="btn-group" role="group">
                          <a class="btn btn-white btn-sm" href="#" data-bs-toggle="modal" data-bs-target="#editClient{{ $client->id }}">
