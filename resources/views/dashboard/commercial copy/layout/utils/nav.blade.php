          ...
          <li class="nav-item">
            ...
            <div class="dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-end navbar-dropdown-menu navbar-dropdown-menu-borderless navbar-dropdown-account" aria-labelledby="accountNavbarDropdown" style="width: 16rem;"><div class="dropdown-item-text">
                ...
                <a class="dropdown-item" href="{{ route('commercial.home') }}"><i class="bi-people nav-icon"></i> Profile</a>
                <div class="dropdown-divider"></div>
        ...
        <div class="navbar-vertical-content">
          <div id="navbarVerticalMenu" class="nav nav-pills nav-vertical card-navbar-nav">
            ...
            <div id="navbarVerticalMenuPagesMenu">
              ...
              <span class="dropdown-header mt-2">Listes des Entreprises/particuliers</span>
              <div class="nav-item">
                <a  class="nav-link dropdown-toggle @if(Route::currentRouteName() === 'commercial.client.index' or Route::currentRouteName() === 'commercial.particulier.index') active @endif" 
                    href="#EntrepriseParticulier" role="button" data-bs-toggle="collapse" data-bs-target="#EntrepriseParticulier" 
                    aria-expanded="false" aria-controls="EntrepriseParticulier">
                  <i class="bi-grid-1x2 nav-icon"></i>
                  <span class="nav-link-title">Entreprises/Particuliers</span>
                </a>
                <div  id="EntrepriseParticulier" 
                      class="nav-collapse collapse @if(Route::currentRouteName() === 'commercial.client.index' or Route::currentRouteName() === 'commercial.particulier.index') show @endif" 
                      data-bs-parent="#navbarVerticalMenuPagesMenu">
                  <a class="nav-link @if(Route::currentRouteName() === 'commercial.client.index' or Route::currentRouteName() === 'commercial.client.edit' or Route::currentRouteName() === 'commercial.client.create') active @endif" href="{{ route('commercial.client.index') }}">Liste des clients </a>
                  <a class="nav-link @if(Route::currentRouteName() === 'commercial.particulier.index' or Route::currentRouteName() === 'commercial.particulier.edit' or Route::currentRouteName() === 'commercial.particulier.create') active @endif" href="{{ route('commercial.particulier.index') }}">Liste des particulier </a>
                </div>
              </div>

              <span class="dropdown-header mt-2">Historiques remises</span>
              <div class="nav-item">
                <a  class="nav-link dropdown-toggle @if(Route::currentRouteName() === 'commercial.client.remise' or Route::currentRouteName() === 'commercial.particulier.remise') active @endif" 
                    href="#remise" role="button" data-bs-toggle="collapse" data-bs-target="#remise" 
                    aria-expanded="false" aria-controls="remise">
                  <i class="bi-grid-1x2 nav-icon"></i>
                  <span class="nav-link-title">Remise</span>
                </a>
                <div  id="remise" 
                      class="nav-collapse collapse @if(Route::currentRouteName() === 'commercial.client.remise' or Route::currentRouteName() === 'commercial.particulier.remise') show @endif" 
                      data-bs-parent="#navbarVerticalMenuPagesMenu">
                  <a class="nav-link @if(Route::currentRouteName() === 'commercial.client.remise') active @endif" href="{{ route('commercial.client.remise') }}">Client </a>
                  <a class="nav-link @if(Route::currentRouteName() === 'commercial.particulier.remise') active @endif" href="{{ route('commercial.particulier.remise') }}">Particulier </a>
                </div>
              </div>
