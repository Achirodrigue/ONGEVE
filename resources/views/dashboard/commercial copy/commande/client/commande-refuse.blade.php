    ...
    <div class="content container-fluid">
      ...
      <div class="page-header">
        <div class="row align-items-center mb-3">
          ...
          <div class="col-auto">
            <a class="btn btn-primary" href="{{ route('commercial.commande.particulier.refuse') }}">
        ...
        <div class="js-nav-scroller hs-nav-scroller-horizontal">
          ...
          <ul class="nav nav-tabs page-header-tabs" id="pageHeaderTab" role="tablist">
            <li class="nav-item">
              <a class="nav-link active" href="#">Commande client refusées</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="{{ route('commercial.commande.particulier.refuse') }}" tabindex="-1" aria-disabled="true">Commandes entreprise refusées</a>
            </li>
          </ul>
          <!-- End Nav -->
        </div>
                        ...
                        <div class="btn-group" role="group">
                          ...
                          <div class="btn-group">
                            ...
                            <div class="dropdown-menu dropdown-menu-end mt-1" aria-labelledby="productsEditDropdown1">
                                <a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#motifRejetClientDevis{{ $clientdevis->id }}">
