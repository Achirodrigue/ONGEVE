    ...
    <div class="content container-fluid">
      ...
      <div class="page-header">
        <div class="row align-items-center">
          <div class="col">
            <h1 class="page-header-title">Mes statistiques</h1>
          </div>
          <!-- End Col -->
          ...
          <div class="card h-100">
            ...
            <div class="card-body">
              ...
              <div class="chartjs-custom">
                <canvas id="updatingBarChart" style="height: 30rem;" data-hs-chartjs-options='{
                          "type": "bar",
                          "data": {
                            "labels": ["Entreprise/Particulier", "Devis traités", "Commandes traitées", "chiffre affaire"],
                            "datasets": [{
                              "data": [ {{$TCPDT}}, 300, 290, 350, 150, 350, 300, 100, 125, 220],
