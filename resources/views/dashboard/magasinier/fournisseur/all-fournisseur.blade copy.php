                  ...
                  @foreach($fournisseurs as $fournisseur)
                    <!-- <tr>
                      <td class="text-center">
                        <a @if($fournisseur->fournisseurfactures()->count() > 0) href="{{ route('magasinier.fournisseur.facture', $fournisseur) }}" @else href="#" @endif class="btn btn-primary">{{ $fournisseur->fournisseurfactures()->count() }}</a>
                      </td>
                    </tr> -->
                    <tr>
                      ...
                      <td class="text-center">
                        <div class="btn-group" role="group">
                          <a class="btn btn-white btn-sm" @if($fournisseur->fournisseurfacturecomptables()->count() > 0) href="{{ route('comptable.fournisseur.facture.impaye', $fournisseur) }}" @else href="#" @endif>
  ...
  <div class="modal fade" id="addfournisseur" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
      <div class="modal-content">
        ...
        <form method="post" action="{{ route('magasinier.fournisseur.store') }}" enctype="multipart/form-data">
        @csrf
          <!-- Body -->
