      ...
      <div class="page-header">
        <div class="row align-items-center mb-3">
          <div class="col-sm mb-2 mb-sm-0">
            <h1 class="page-header-title">Commandes d'entreprise livrées <span class="badge bg-soft-dark text-dark ms-2">{{ $particulierdevis->count() }}</span></h1>
          ...
          <div class="col-auto">
            <a class="btn btn-primary" href="{{ route('magasinier.commande.particulier.valide') }}">
              <i class="bi-arrow-return-left me-1"></i> Commandes en cours de livraison
            </a>
          </div>
          <!-- End Col -->
        </div>
        ...
        <div class="js-nav-scroller hs-nav-scroller-horizontal">
          ...
          <ul class="nav nav-tabs page-header-tabs" id="pageHeaderTab" role="tablist">
            <li class="nav-item">
              <a class="nav-link" href="{{ route('magasinier.commande.particulier.valide') }}" tabindex="-1" aria-disabled="true">Commandes en attente de livraison</a>
            </li>
            <li class="nav-item">
              <a class="nav-link active" href="#">Commandes entreprise livrées</a>
            </li>
          </ul>
          <!-- End Nav -->
        </div>
