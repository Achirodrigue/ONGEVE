      ...
      <div class="page-header">
        <div class="row align-items-center mb-3">
          <div class="col-sm mb-2 mb-sm-0">
            <h1 class="page-header-title">Nombre de factures client de location livrées sans retour <span class="badge bg-soft-dark text-dark ms-2">{{ $clientdevis->count() }}</span></h1>
          </div>
        </div>
        <!-- End Row -->
          ...
          <ul class="nav nav-tabs page-header-tabs" id="pageHeaderTab" role="tablist">
            <li class="nav-item">
              <a class="nav-link active" href="#">
                Factures livrées sans retour
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="{{ route('magasinier.facture.location.livre.avec.retour') }}" tabindex="-1" aria-disabled="true">
                Factures livrées avec retour
              </a>
            </li>
          </ul>
          <!-- End Nav -->
      ...
      <div class="card card-table">
                ...
                <tbody>
                  @foreach($clientdevis as $clientdevis)
                    <tr>
                      ...
                      <td>
                        <div class="btn-group" role="group">
                          <a class="btn btn-white btn-sm" href="{{ route('commun.facture.location.livre.confirme.retour', $clientdevis) }}">
                            <i class="bi-printer me-1"></i> Confirmer le retour
                          </a>
                        </div>
                      </td>
                    </tr>
          ...
          @else
              ...
              <div class="card-header card-header-content-md-between p-4">
                <h3 class="fw-bold mb-0 text-center">Désolé! Aucune facture client livré non retourné sur la plateforme</h3>
              </div>
              <!-- End Header -->
          @endif
      </div>
