...
@section('body')
  ...
  <main id="content" role="main" class="main">
    ...
    <div class="content container-fluid">
      ...
      <div class="page-header">
        ...
        <div class="js-nav-scroller hs-nav-scroller-horizontal">
          ...
          <ul class="nav nav-tabs page-header-tabs" id="pageHeaderTab" role="tablist">
            <li class="nav-item">
              <a class="nav-link" href="{{ route('magasinier.fournisseur.index') }}" tabindex="-1" aria-disabled="true">fournisseurs</a>
            </li>
            <li class="nav-item">
      ...
      <form method="POST" action="{{ route('magasinier.fournisseur.facture.store.add', ['fournisseur'=>$fournisseur , 'produit'=>$produit]) }}" enctype="multipart/form-data">
        @csrf
          <div class="row">
            ...
            <div class="card card-sm bg-dark border-dark mx-2">
              <div class="card-body">
                <div class="row justify-content-center justify-content-sm-between">
                  <div class="col">
                    <a href="{{ route('magasinier.fournisseur.index') }}" class="btn btn-ghost-danger">Retour</a>
                  </div>
