              ...
              <div class="js-sticky-block card mb-3 mb-lg-5" data-hs-sticky-block-options='{
                ...
                <div class="card-body">
                  <ul class="list-unstyled list-py-2 text-dark mb-0">
                    ...
                    <li class="pt-4 pb-0"><span class="card-subtitle">Role</span></li>
                    <li><i class="bi-person dropdown-item-icon"></i> {{ auth()->user()->role ? 'Responsable gestionnaire de stock' : 'Magasinier' }}</li>
                  </ul>
                </div>
                <!-- End Body -->
              </div>
              ...
              <div class="d-grid gap-3 gap-lg-5">
                ...
                <div class="card">
                  ...
                  <div class="card-body"><!--  card-body-height" style="height: 30rem;  -->
                    <form method="POST" action="{{ route('geststock.profil.update') }}" enctype="multipart/form-data">
                      @csrf
                      @method('PATCH')
