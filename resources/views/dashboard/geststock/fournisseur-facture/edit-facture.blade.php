    ...
    <div class="content container-fluid">
      ...
      <div class="page-header">
        <div class="row align-items-center mb-3">
          ...
          <div class="col-auto">
            <a class="btn btn-primary" href="{{ route('geststock.fournisseur.facture.invalide') }}">
        ...
        <div class="js-nav-scroller hs-nav-scroller-horizontal">
          ...
          <ul class="nav nav-tabs page-header-tabs" id="pageHeaderTab" role="tablist">
            <li class="nav-item">
              <a class="nav-link" href="{{ route('geststock.fournisseur.facture.invalide') }}" tabindex="-1" aria-disabled="true">Facture en cours de traitement</a>
            </li>
            <li class="nav-item">
            ...
            <div class="card card-sm bg-dark border-dark mx-2">
              <div class="card-body">
                <div class="row justify-content-center justify-content-sm-between">
                  <div class="col">
                    <a href="{{ route('geststock.fournisseur.facture.invalide') }}" class="btn btn-ghost-danger">Retour</a>
                  </div>
