      ...
      <div class="page-header">
        <div class="row align-items-center mb-3">
          <div class="col-sm mb-2 mb-sm-0">
            <h1 class="page-header-title">Les différentes factures fournisseur en attente de reception<span class="badge bg-soft-dark text-dark ms-2">{{ $fournisseurfactures->count() }}</span></h1>
          </div>
        </div>
        <!-- End Row -->
        ...
        <div class="js-nav-scroller hs-nav-scroller-horizontal">
          ...
          <ul class="nav nav-tabs page-header-tabs" id="pageHeaderTab" role="tablist">
            ...
            <li class="nav-item">
              <a class="nav-link" href="{{ route('geststock.generale.fournisseur.facture.reception.valide') }}" tabindex="-1" aria-disabled="true">
       ...
       <div class="card card-table">
                            ...
                            <div class="btn-group">
                              ...
                              <div class="dropdown-menu dropdown-menu-top mt-1" aria-labelledby="productsEditDrop{{ $fournisseurfacture->id }}down">
                                ...
                                <a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#confirmeReceptionFF{{ $fournisseurfacture->id }}">
                                  <i class="bi-check dropdown-item-icon"></i>@if($fournisseurfacture->livraison) annuler @else confirmer @endif la reception
                                </a>
          ...
          @else
              ...
              <div class="card-header card-header-content-md-between p-4">
                <h3 class="fw-bold mb-0 text-center">Désolé! Aucune facture fournisseur établie et receptionné sur la plateforme</h3>
              </div>
              <!-- End Header -->
          @endif
      </div>
