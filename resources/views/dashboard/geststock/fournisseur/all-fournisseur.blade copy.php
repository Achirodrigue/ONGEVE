          ...
          @if($fournisseurs->count() > 0)
            ...
            <div class="table-responsive datatable-custom">
              <table id="datatable" class="table table-bordered table-hover table-borderless table-thead-bordered table-nowrap table-align-middle card-table" style="width: 100%" data-hs-datatables-options='{
                ...
                <thead class="thead-light">
                  <tr>
                    ...
                    <th class="text-center">Ajouter facture</th>
                    <th>Action</th>
                  </tr>
                </thead>
              ...
              <i class="bi-person-plus-fill me-1"></i> Ajouter une facture
                          ...
                          <a class="btn btn-white btn-sm" href="#" data-bs-toggle="modal" data-bs-target="#addFournisseurFactureComptable" href="{{ route('geststock.facture.fournisseur.reception.encours', $fournisseur) }}">
