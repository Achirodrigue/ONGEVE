        ...
        <div class="row align-items-center mb-3">
          <div class="col-sm mb-2 mb-sm-0">
            <h1 class="page-header-title">
              Stock des produits de la catégorie 
              <span class="text-danger">{{ $entrepotcateg->categorie->nom }}</span> de l'entrepôt
              <span class="text-danger">{{ $entrepotcateg->categorieprod->nom }}</span> 
          ...
          <div class="col-auto">
            <a class="btn btn-primary" href="#" data-bs-toggle="modal" data-bs-target="#entrepotFamilleProduit">
              <i class="bi-eye me-1"></i> Famille de produit
            </a>
          </div>
        </div>
          ...
          @else
              ...
              <div class="card-header card-header-content-md-between p-4">
                <h3 class="fw-bold mb-0 text-center">
                  Désolé! Aucun produit n'a été ajouté dans la catégorie <span class="text-danger">{{ $entrepotcateg->categorie->nom }}</span> de l'entrepôt <span class="text-danger">{{ $entrepotcateg->categorieprod->nom }}</span></h3>
              </div>
              <!-- End Header -->
          @endif
      </div>
