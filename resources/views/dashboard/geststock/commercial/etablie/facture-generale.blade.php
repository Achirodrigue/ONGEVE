      ...
      <div class="page-header">
        <div class="row align-items-center mb-3">
          <div class="col-sm mb-2 mb-sm-0">
            <h1 class="page-header-title">Nombre de factures client établie <span class="badge bg-soft-dark text-dark ms-2">{{ $clientdevis->count() }}</span></h1>
          </div>
        </div>
        <!-- End Row -->
       ...
       <div class="card card-table">
                ...
                <tbody>
                  ...
                  @foreach($clientdevis as $clientdevis)
                    ...
                    <tr>
                      ...
                      <td class="fw-bold">{{ $clientdevis->commercial->nom }} {{ $clientdevis->commercial->prenom }}</td>
          ...
          @else
              ...
              <div class="card-header card-header-content-md-between p-4">
                <h3 class="fw-bold mb-0 text-center">Désolé! Aucune facture client établie sur la plateforme</h3>
              </div>
              <!-- End Header -->
          @endif
      </div>
