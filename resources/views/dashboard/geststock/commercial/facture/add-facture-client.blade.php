...
@section('body')
  ...
  <main id="content" role="main" class="main">
    ...
    <div class="content container-fluid">
      ...
      <div class="page-header">
        <div class="row align-items-center">
          <div class="col-sm mb-2 mb-sm-0">
            <h1 class="page-header-title">Ajouter un(e) facture/devis client pour le commercial <span class="text-danger">{{ $commercial->nom }} {{ $commercial->prenom }}</span></h1>
      ...
      <form method="POST" action="{{ route('geststock.commercial.facture.client.store', $commercial) }}" enctype="multipart/form-data">
        @csrf
          <div class="row">
            <div class="col-lg-8">
              <div class="card mb-3 mb-lg-5">
                ...
                <div class="card-body">
                  ...
                  <div class="row">
                      ...
                      <div class="mb-4">
                        ...
                        <div class="tom-select-custom">
                          <select id="client" onchange="toggleInput()" name="client" class="js-select form-select" autocomplete="off" data-hs-tom-select-options='{
                            ...
                            <option value="Nouveau">Choisir un client</option>
                            @if(clients()->count() > 0)
                              <option value="ChoisirClient">Nouveau client</option>
                            @endif
                          </select>
                        </div>
                      </div>
                    ...
                    <div id="ChoisirClient" style="display: none;">
                      <div class="row">
                        <hr>
              ...
              <div class="card card-table" id="addClient" style="display: block;">
                  @if(clients()->count() > 0)
                    <!-- Header -->
            ...
            <div class="card card-sm bg-dark border-dark mx-2">
              <div class="card-body">
                <div class="row justify-content-center justify-content-sm-between">
                  <div class="col">
                    <a href="{{ route('geststock.all.commercial') }}" class="btn btn-ghost-danger">Retour</a>
                  </div>
