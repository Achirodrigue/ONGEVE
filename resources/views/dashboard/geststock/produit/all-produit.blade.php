      ...
      <div class="page-header">
        <div class="row align-items-center mb-3">
          <div class="col-sm mb-2 mb-sm-0">
            <h1 class="page-header-title">Tout les produits disponible sur la plateforme <span class="badge bg-soft-dark text-dark ms-2">{{ $produits->count() }}</span></h1>
          </div>
          <!-- End Col -->
                ...
                <tbody>
                  ...
                  @foreach($produits as $produit)
                    ...
                    <tr>
                      ...
                      <!-- <td class="fw-bold">{{ $produit->reff }}</td> -->
                      ...
                      <td class="fw-bold">{{ $produit->entrepotcateg->categorieprod->nom }}</td>
                      <td>
                        <div class="btn-group" role="group">
