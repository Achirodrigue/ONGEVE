              ...
              <div class="d-flex gap-3" style="flex-wrap: wrap; align-items: center; justify-content: space-between;">
                @if(entrepotcategs()->count() > 0)
                  @foreach(categories() as $categorie)
                    <a href="{{ route('geststock.stock.global.produit', $categorie) }}" class="btn btn-white">{{ $categorie->nom }}</a>
                  @endforeach
                @else
  ...
  <div class="modal fade" id="entrepotFamilleProduit" tabindex="-1" aria-labelledby="createAKIKeyModalLabel" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header mb-3">
          <h4 class="modal-title" id="createAKIKeyModalLabel">Choisir l'entrepôt de produit</h4>
              ...
              <div class="d-flex gap-3" style="flex-wrap: wrap; align-items: center; justify-content: space-between;">
                @if(entrepotcategs()->count() > 0)
                  @foreach(entrepotcategs() as $entrepotcateg)
                    <a href="{{ route('geststock.stock.global.famille.produit', $entrepotcateg) }}" class="btn btn-white">{{ $entrepotcateg->categorie->nom }} : {{ $entrepotcateg->categorieprod->nom }}</a>
                  @endforeach
                @else
                  <p>Fonction indisponible</p>
                @endif
  ...
  <div class="modal fade" id="choixPeriodeClassementProduit" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title" id="createAKIKeyModalLabel">Produits les mieux vendu</h4>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>

        <form method="get" action="{{ route('geststock.classement.produit.vendu') }}" enctype="multipart/form-data">
        @csrf
          <div class="modal-body">
            ...
            <div class="row mb-4">
              <div class="col-sm-3 mb-2 mb-sm-0">
                <div class="d-flex align-items-center mt-2">
                  ...
                  <div class="flex-grow-1">type de choix *</div>
                </div>
              </div>
              <div class="col-sm">
                <label for="role" class="visually-hidden form-label">Type de choix *</label>
                <select id="PouSPprod" onchange="PorSPprod()" name="PouSPprod" class="form-control w-100" id="role" required>
                    <option value="P">Periode</option>
                    <option value="SP">Sans periode</option>
                </select>
                @error('PouSP') <span class="text-danger">{{ $message }}</span> @enderror
              </div>
            </div>
            ...
            <div id="PeriodeProd">
              <div class="row mb-4">
                ...
                <div class="col-sm">
                  ...
                  <input type="date" name="start_date" value="{{ old('start_date') }}" class="form-control" id="start_date" placeholder="Entrer une date de debut">
            ...
            <div class="row mb-4">
              <div class="col-sm-3 mb-2 mb-sm-0">
                <div class="d-flex align-items-center mt-2">
                  <i class="bi-list-ul nav-icon"></i>
                  <div class="flex-grow-1">type de Sortie *</div>
                </div>
              </div>
              <div class="col-sm">
                <label for="TS" class="visually-hidden form-label">Type de Sortie *</label>
                <select name="TS" class="form-control w-100" id="TS" required>
                    <option value="vente">Vente</option>
                    <option value="location">Location</option>
                </select>
                @error('TS') <span class="text-danger">{{ $message }}</span> @enderror
              </div>
            </div>
