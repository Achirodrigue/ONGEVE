      ...
      <div class="page-header">
        <div class="row align-items-center mb-3">
          <div class="col-sm mb-2 mb-sm-0">
            <h1 class="page-header-title">Nombre de commandes d'entreprise refusées <span class="badge bg-soft-dark text-dark ms-2">{{ $particulierdevis->count() }}</span></h1>

          </div>
          <!-- End Col -->

          <div class="col-auto">
            <a class="btn btn-primary" href="{{ route('comptable.commande.client.refuse') }}">
        ...
        <div class="js-nav-scroller hs-nav-scroller-horizontal">
          ...
          <ul class="nav nav-tabs page-header-tabs" id="pageHeaderTab" role="tablist">
            <li class="nav-item">
              <a class="nav-link" href="{{ route('comptable.commande.client.refuse') }}" tabindex="-1" aria-disabled="true">Particulier</a>
            </li>
            <li class="nav-item">
                ...
                <tbody>
                  @foreach($particulierdevis as $particulierdevis)
                    <tr>
                      ...
                      <td>
                        <div class="btn-group" role="group">
                          <a class="btn btn-white btn-sm" href="{{ route('comptable.annuler.rejet.commande.particulier', $particulierdevis) }}">
