    ...
    <div class="content container-fluid">
      ...
      <div class="page-header">
        <div class="row align-items-center mb-3">
          ...
          <div class="col-auto">
            <a class="btn btn-primary" href="{{ route('comptable.commande.particulier.valide') }}">
              <i class="bi-eye me-1"></i> Commandes Entreprise validées
            </a>
          </div>
          <!-- End Col -->
        </div>
        ...
        <div class="js-nav-scroller hs-nav-scroller-horizontal">
          ...
          <ul class="nav nav-tabs page-header-tabs" id="pageHeaderTab" role="tablist">
            ...
            <li class="nav-item">
              <a class="nav-link" href="{{ route('comptable.commande.particulier.valide') }}" tabindex="-1" aria-disabled="true">Entreprise</a>
            </li>
          </ul>
          <!-- End Nav -->
        </div>
