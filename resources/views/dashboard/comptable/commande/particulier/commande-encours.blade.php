      ...
      <div class="page-header">
        <div class="row align-items-center mb-3">
          <div class="col-sm mb-2 mb-sm-0">
            <h1 class="page-header-title">Nombre de commande d'entreprise en cours <span class="badge bg-soft-dark text-dark ms-2">{{ $particulierdevis->count() }}</span></h1>
          </div>
          <!-- End Col -->

          <div class="col-auto">
            <a class="btn btn-primary" href="{{ route('comptable.commande.client.encours') }}">
              <i class="bi-arrow-return-left me-1"></i> Commandes client en cours
            </a>
          </div>
          <!-- End Col -->
        </div>
        ...
        <div class="js-nav-scroller hs-nav-scroller-horizontal">
          ...
          <ul class="nav nav-tabs page-header-tabs" id="pageHeaderTab" role="tablist">
            <li class="nav-item">
              <a class="nav-link" href="{{ route('comptable.commande.client.encours') }}" tabindex="-1" aria-disabled="true">Particulier</a>
            </li>
            <li class="nav-item">
      ...
      <div class="card">
                        ...
                        <div class="btn-group" role="group">
                          ...
                          <div class="btn-group">
                            ...
                            <div class="dropdown-menu dropdown-menu-end mt-1" aria-labelledby="productsEditDropdown1">
                              <a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#validerParticulierDevis{{ $particulierdevis->id }}">
                                <i class="bi-patch-check-fill text-primary me-1 dropdown-item-icon"></i> Valider
                              </a>
                              <a class="dropdown-item" href="#">
                                <i class="bi-patch-check-fill text-primary me-1 dropdown-item-icon"></i> Valider
                              </a>
                              <a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#rejetCommandeParticulier{{ $particulierdevis->id }}">
          ...
          @else
              ...
              <div class="card-header card-header-content-md-between p-4">
                <h3 class="fw-bold mb-0 text-center">Désolé! Aucune commande entreprise n'est en cours sur la plateforme</h3>
              </div>
              <!-- End Header -->
          @endif
      </div>
