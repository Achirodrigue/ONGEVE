              ...
              <div class="row justify-content-md-end mb-3">
                <div class="col-md-8 col-lg-7">
                  <dl class="row text-sm-end">
                    ...
                    <dt class="col-sm-6">AIRSI @if($clientdevis->airsi) <span class="text-danger font-remise">({{ $clientdevis->airsi }}%)</span> @endif :</dt>
                    <dd class="col-sm-6">@if($clientdevis->airsi) {{ getpricefr($clientdevis->airsi_montant) }} @else Aucune @endif</dd>
                    ...
                    <dd class="col-sm-6">@if($clientdevis->timbre) {{ getpricefr($clientdevis->timbre_montant) }} @else Aucun @endif</dd>
