    ...
    <div class="content container-fluid">
      ...
      <div class="page-header">
        <div class="row align-items-center mb-3">
          ...
          <div class="col-auto">
            <a class="btn btn-primary" href="{{ route('comptable.client.commande.impaye', $clientdevis->client) }}">
        ...
        <div class="js-nav-scroller hs-nav-scroller-horizontal">
          ...
          <ul class="nav nav-tabs page-header-tabs" id="pageHeaderTab" role="tablist">
            <li class="nav-item">
              <a class="nav-link" href="{{ route('comptable.commande.client.impaye') }}">Commandes Impayées</a>
            </li>
            <li class="nav-item">
