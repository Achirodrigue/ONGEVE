      ...
      <div class="page-header">
        <div class="row align-items-center mb-3">
          <div class="col-sm mb-2 mb-sm-0">
            <h1 class="page-header-title">Les différents clients non commandé depuis 1 mois<span class="badge bg-soft-dark text-dark ms-2">{{ $clients->count() }}</span></h1>
          </div>
        ...
        <div class="js-nav-scroller hs-nav-scroller-horizontal">
          ...
          <ul class="nav nav-tabs page-header-tabs" id="pageHeaderTab" role="tablist">
            <li class="nav-item">
              <a class="nav-link" href="{{ route('comptable.client.rappel.vente.jours') }}" tabindex="-1" aria-disabled="true">Clients depuis 15 jours</a>
            </li>
            <li class="nav-item">
      ...
      <div class="card card-table">
          ...
          @else
              ...
              <div class="card-header card-header-content-md-between p-4">
                <h3 class="fw-bold mb-0 text-center">Désolé! Aucun client n'a de facture incommandé depuis 1 mois</h3>
              </div>
              <!-- End Header -->
          @endif
      </div>
