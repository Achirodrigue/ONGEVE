      ...
      <div class="page-header">
        <div class="row align-items-center mb-3">
          <div class="col-sm mb-2 mb-sm-0">
            <h1 class="page-header-title">Chiffres d'affaire des comptes client partiellement payés <span class="badge bg-soft-dark text-dark ms-2">{{ $clientdevis->count() }}</span></h1>
          </div>

          @if($clientdevis->count() > 0)
            <div class="col-auto">
              <a class="btn btn-primary" href="{{ route('comptable.client.facture.general.CA.export', ['statut' => 2]) }}">
