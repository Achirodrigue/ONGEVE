      ...
      <div class="page-header">
        <div class="row align-items-center mb-3">
          <div class="col-sm mb-2 mb-sm-0">
            <h1 class="page-header-title">Les différents clients ajoutés par la comptabilité <span class="badge bg-soft-dark text-dark ms-2">{{ $clients->count() }}</span></h1>
          ...
          <div class="col-auto">
            <a class="btn btn-primary" href="{{ route('comptable.client.create') }}">
              <i class="bi-person-plus-fill me-1"></i> Ajouter un client
            </a>
          </div>
          <!-- End Col -->
        </div>
        ...
        <div class="js-nav-scroller hs-nav-scroller-horizontal">
          ...
          <ul class="nav nav-tabs page-header-tabs" id="pageHeaderTab" role="tablist">
            <li class="nav-item">
              <a class="nav-link" href="{{ route('comptable.client.index') }}" tabindex="-1" aria-disabled="true">Tout les clients</a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
              <a class="nav-link" href="{{ route('comptable.commercial.client') }}" tabindex="-1" aria-disabled="true">
                Commerciaux clients
              </a>
            </li>
          </ul>
      ...
      <div class="card card-table">
              ...
              <div class="mb-2 mb-md-0 w-100">
                <form>
                  ...
                  <div class="input-group input-group-merge input-group-flush">
                    ...
                    <input id="datatableSearch" type="search" class="form-control" placeholder="Rechercher un client" aria-label="Search users">
                  </div>
                  <!-- End Search -->
                </form>
              </div>
                ...
                <tbody>
                  ...
                  @foreach($clients as $client)
                    ...
                    <tr>
                      ...
                      <td class="fw-bold">@if($client->Pachat) {{ getprice($client->Pachat) }} @else Aucun @endif</td>
                      ...
                      <td class="text-center">
                        <div class="btn-group" role="group">
                          <a class="btn btn-white btn-sm" 
                              @if($client->clientdevis()->whereHas('clientdevisinfo', function ($query) { $query->where('isvalide', 1); })->count() > 0) 
                                href="{{ route('comptable.client.commande.impaye', $client) }}" 
                              @else href="#" @endif>
                              <i class="bi-eye me-1"></i> {{ $client->clientdevis()->whereHas('clientdevisinfo', function ($query) { $query->where('isvalide', 1); })->count() }}
                          </a>
                        </div>
                      </td>
                      <td class="text-center">
                        <div class="btn-group" role="group">
                          <a class="btn btn-white btn-sm" href="{{ route('comptable.client.edit', $client) }}">
          ...
          @else
              ...
              <div class="card-header card-header-content-md-between p-4">
                <h3 class="fw-bold mb-0 text-center">Désolé! Aucun client n'a été ajouté par la comptabilité sur la plateforme</h3>
              </div>
              <!-- End Header -->
          @endif
      </div>
