      ...
      <div class="page-header">
        <div class="row align-items-center mb-3">
          <div class="col-sm mb-2 mb-sm-0">
            <h1 class="page-header-title">Les différents clients ajoutés par les commerciaux <span class="badge bg-soft-dark text-dark ms-2">{{ $clients->count() }}</span></h1>
        ...
        <div class="js-nav-scroller hs-nav-scroller-horizontal">
          ...
          <ul class="nav nav-tabs page-header-tabs" id="pageHeaderTab" role="tablist">
            ...
            <li class="nav-item">
              <a class="nav-link" href="{{ route('comptable.comptable.client') }}" tabindex="-1" aria-disabled="true">
      ...
      <div class="card card-table">
          ...
          @else
              ...
              <div class="card-header card-header-content-md-between p-4">
                <h3 class="fw-bold mb-0 text-center">Désolé! Aucun client n'a été ajouté par les commerciaux sur la plateforme</h3>
              </div>
              <!-- End Header -->
          @endif
      </div>
