      ...
      <div class="page-header">
        <div class="row align-items-center mb-3">
          <div class="col-sm mb-2 mb-sm-0">
            <h1 class="page-header-title">Etat des comptes fournisseurs finalisées sur la plateforme <span class="badge bg-soft-dark text-dark ms-2">{{ $fournisseurfacturecomptables->count() }}</span></h1>
          </div>

          <div class="col-auto">
            @if($fournisseurfacturecomptables->count() > 0)
              <a class="btn btn-primary" href="{{ route('comptable.fournisseur.facture.general.export', ['statut' => 1]) }}">
