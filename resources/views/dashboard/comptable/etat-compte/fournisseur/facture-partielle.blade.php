      ...
      <div class="page-header">
        <div class="row align-items-center mb-3">
          <div class="col-sm mb-2 mb-sm-0">
            <h1 class="page-header-title">Etat des comptes fournisseurs partiellement payés sur la plateforme <span class="badge bg-soft-dark text-dark ms-2">{{ $fournisseurfacturecomptables->count() }}</span></h1>
          </div>

          <div class="col-auto">
            @if($fournisseurfacturecomptables->count() > 0)
              <a class="btn btn-primary" href="{{ route('comptable.fournisseur.facture.general.export', ['statut' => 2]) }}">
        ...
        <div class="js-nav-scroller hs-nav-scroller-horizontal">
          ...
          <ul class="nav nav-tabs page-header-tabs" id="pageHeaderTab" role="tablist">
            <li class="nav-item">
              <a class="nav-link" href="{{ route('comptable.all.facture.fournisseur.impaye') }}" tabindex="-1" aria-disabled="true">
                Factures Impayées
