      ...
      <div class="page-header">
        <div class="row align-items-center mb-3">
          <div class="col-sm mb-2 mb-sm-0">
            <h1 class="page-header-title">Etat des comptes client finalisées <span class="badge bg-soft-dark text-dark ms-2">{{ $clientdevis->count() }}</span></h1>
          </div>
          <!-- End Col -->

          <div class="col-auto">
            @if($clientdevis->count() > 0)
              <a class="btn btn-primary" href="{{ route('comptable.client.facture.general.export', ['statut' => 1]) }}">
