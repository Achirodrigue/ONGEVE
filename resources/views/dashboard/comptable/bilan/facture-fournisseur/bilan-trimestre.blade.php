      ...
      <div class="page-header">
        <div class="row align-items-center mb-3">
          <div class="col-sm mb-2 mb-sm-0">
            <h1 class="page-header-title">Bilans trimestriel des factures fournisseur sur la plateforme <span class="badge bg-soft-dark text-dark ms-2">{{ $fournisseurfacturecomptables->count() }}</span></h1>
          </div>
          <!-- End Col -->
        </div>
        <!-- End Row -->
        ...
        <div class="js-nav-scroller hs-nav-scroller-horizontal">
          ...
          <ul class="nav nav-tabs page-header-tabs" id="pageHeaderTab" role="tablist">
            ...
            <li class="nav-item">
              <a class="nav-link" href="{{ route('comptable.bilan.mois.facture.fournisseur') }}" tabindex="-1" aria-disabled="true">Bilans par mois</a>
            </li>
            <li class="nav-item">
                      ...
                      <td class="text-center">
                        <div class="btn-group" role="group">
                          ...
                          <a class="btn btn-white btn-sm" 
                            @if($factures->count() > 0) 
                                href="{{ route('comptable.bilan.periode.facture.fournisseur', ['ids' => $ids, 'periode' => $periode, 'type' => 2]) }}" 
                            @else 
                                href="#" 
                            @endif>
