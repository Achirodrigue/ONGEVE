      ...
      <div class="page-header">
        <div class="row align-items-center mb-3">
          <div class="col-sm mb-2 mb-sm-0">
            <h1 class="page-header-title">Bilans annuels des factures fournisseur sur la plateforme <span class="badge bg-soft-dark text-dark ms-2">{{ $fournisseurfacturecomptables->count() }}</span></h1>
          </div>
        </div>
        <!-- End Row -->
                      ...
                      <td class="text-center">
                        <div class="btn-group" role="group">
                          ...
                          <a class="btn btn-white btn-sm" 
                            @if($factures->count() > 0) 
                                href="{{ route('comptable.bilan.periode.facture.fournisseur', ['ids' => $ids, 'periode' => $periode, 'type' => 3]) }}" 
                            @else 
                                href="#" 
                            @endif>
