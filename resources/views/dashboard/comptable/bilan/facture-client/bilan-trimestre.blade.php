      ...
      <div class="page-header">
        ...
        <div class="js-nav-scroller hs-nav-scroller-horizontal">
          ...
          <ul class="nav nav-tabs page-header-tabs" id="pageHeaderTab" role="tablist">
            ...
            <li class="nav-item">
              <a class="nav-link" href="{{ route('comptable.bilan.annee.facture.client') }}" tabindex="-1" aria-disabled="true">Bilans annuels</a>
            </li>
          </ul>
          <!-- End Nav -->
        </div>
                      ...
                      <td class="text-center">
                        <div class="btn-group" role="group">
                          ...
                          <a class="btn btn-white btn-sm" 
                            @if($factures->count() > 0) 
                                href="{{ route('comptable.bilan.periode.facture.client', ['ids' => $ids, 'periode' => $periode, 'type' => 2]) }}" 
                            @else 
                                href="#" 
                            @endif>
