...
@section('body')
  ...
  <main id="content" role="main" class="main">
    ...
    <div class="content container-fluid">
      ...
      <div class="page-header">
        <div class="row align-items-center">
          <div class="col-sm mb-2 mb-sm-0">
            <h1 class="page-header-title">Ajouter une facture pour un <span class="text-warning">Client</span></h1>
      ...
      <form method="POST" action="{{ route('comptable.facture.client.store') }}" enctype="multipart/form-data">
        @csrf
          <div class="row">
            <div class="col-lg-8">
