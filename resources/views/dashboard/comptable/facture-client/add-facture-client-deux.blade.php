            ...
            <div class="row justify-content-end">
                <div class="col-auto">
                  @if($clientdevis->clientdevisprods()->count() > 0)
                    ...
                    <a class="btn btn-white mb-2" href="{{ route('comptable.commande.client.detail', $clientdevis) }}">
              ...
              <table class="table table-bordered table-hover table-borderless table-thead-bordered table-nowrap table-align-middle card-table" style="width: 100%" data-hs-datatables-options='{
                ...
                <tbody>
                  @foreach($clientdevis->clientdevisprods as $clientdevisprod)
                    ...
                    @include('include.CG.clientdevisprod')
                  @endforeach
                </tbody>
              </table>
            </div>
              ...
              <table id="datatable" class="table table-bordered table-hover table-borderless table-thead-bordered table-nowrap table-align-middle card-table" style="width: 100%" data-hs-datatables-options='{
                ...
                <tbody>
                  ...
                  @php $a = $n ; @endphp
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="btn-group" role="group">
                          ...
                          <a class="btn btn-white btn-sm" href="#" data-bs-toggle="modal" data-bs-target="#editProduit{{ $produit->id }}">
                    ...
                    @include('include.CG.produit-devis')
                    @include('include.commun.produit')
                  @endforeach
                </tbody>
              </table>
            </div>
