...
@section('body')
  ...
  @include('include.commun.geststock.fournisseur2')
  @include('include.commun.comptable.fournisseur-facture')
              ...
              <div class="mb-2 mb-md-0 w-100">
                <form>
                  ...
                  <div class="input-group input-group-merge input-group-flush">
                    ...
                    <input id="datatableSearch" type="search" class="form-control" placeholder="Rechercher un fournisseur" aria-label="Search users">
                  </div>
                  <!-- End Search -->
                </form>
              </div>
                ...
                <tbody>
                  ...
                  @foreach($fournisseurs as $fournisseur)
                    <tr>
                      ...
                      <td class="fw-bold">@if($fournisseur->reff) {{ $fournisseur->reff }} @else Aucune @endif</td>
                    ...
                    @include('include.commun.geststock.fournisseur')
                  @endforeach
                </tbody>
              </table>
            </div>
