      ...
      <div class="page-header">
        ...
        <div class="js-nav-scroller hs-nav-scroller-horizontal">
          ...
          <ul class="nav nav-tabs page-header-tabs" id="pageHeaderTab" role="tablist">
            <li class="nav-item">
              <a class="nav-link" href="{{ route('comptable.fournisseur.facture.invalide') }}" tabindex="-1" aria-disabled="true">Factures en cours de traitement</a>
            </li>
            <li class="nav-item">
                      ...
                      <td class="text-center">
                        <div class="btn-group" role="group">
                          <a class="btn btn-white btn-sm" href="{{ route('comptable.fournisseur.facture.etat.update', $fournisseurfacture) }}">
                            <i class="bi-printer me-1"></i> Retirer
                          </a>
                        </div>
                      </td>
                    </tr>
