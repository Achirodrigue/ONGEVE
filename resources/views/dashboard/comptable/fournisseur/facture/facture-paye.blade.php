      ...
      <div class="page-header">
        <div class="row align-items-center mb-3">
          ...
          <div class="col-auto">
            @if($fournisseur->fournisseurfacturecomptables->count() > 0)
              <a class="btn btn-primary" href="{{ route('comptable.fournisseur.facture.individuel.export', ['fournisseur' => $fournisseur->id, 'statut' => 1]) }}">
        ...
        <div class="js-nav-scroller hs-nav-scroller-horizontal">
          ...
          <ul class="nav nav-tabs page-header-tabs" id="pageHeaderTab" role="tablist">
            ...
            <li class="nav-item">
              <a class="nav-link" href="{{ route('comptable.fournisseur.facture.partielle', $fournisseur) }}" tabindex="-1" aria-disabled="true">
                Factures Partielle
