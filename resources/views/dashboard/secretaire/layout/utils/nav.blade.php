          ...
          <li class="nav-item">
            ...
            <div class="dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-end navbar-dropdown-menu navbar-dropdown-menu-borderless navbar-dropdown-account" aria-labelledby="accountNavbarDropdown" style="width: 16rem;"><div class="dropdown-item-text">
                ...
                <a class="dropdown-item" href="{{ route('comptable.profil') }}"><i class="bi-people nav-icon"></i> Profile</a>
                <div class="dropdown-divider"></div>
                <form action="{{ route('comptable.logout') }}" method="post">
                @csrf
          ...
          <div id="navbarVerticalMenu" class="nav nav-pills nav-vertical card-navbar-nav">
            ...
            <div class="nav-item">
              ...
              <div id="navbarVerticalMenuDashboards" class="nav-collapse collapse @if(Route::currentRouteName() === 'comptable.home') show @endif" data-bs-parent="#navbarVerticalMenu">
                <a class="nav-link @if(Route::currentRouteName() === 'comptable.home') active @endif" href="{{ route('comptable.home') }}">Accueil</a>
              </div>
            </div>
            <!-- End Collapse -->
            ...
            <div id="navbarVerticalMenuPagesMenu">
              ...
              <div class="nav-item">
                <a class="nav-link @if(Route::currentRouteName() === 'comptable.client.index' or Route::currentRouteName() === 'comptable.client.edit' or Route::currentRouteName() === 'comptable.client.create' or Route::currentRouteName() === 'comptable.commande.client') active @endif" href="{{ route('comptable.client.index') }}" data-placement="left">
              ...
              <div class="nav-item">
                <a class="nav-link @if(Route::currentRouteName() === 'comptable.fournisseur.index' or Route::currentRouteName() === 'comptable.fournisseur.impaye' or Route::currentRouteName() === 'comptable.fournisseur.partielle' or Route::currentRouteName() === 'comptable.fournisseur.paye') active @endif" href="{{ route('comptable.fournisseur.index') }}" data-placement="left">
                  <i class="bi-people nav-icon"></i>
              ...
              <div class="nav-item">
                <a class="nav-link @if(Route::currentRouteName() === 'comptable.chiffre.affaire.client.paye' or Route::currentRouteName() === 'comptable.client.edit' or Route::currentRouteName() === 'comptable.chiffre.affaire.client.partielle' or Route::currentRouteName() === 'comptable.chiffre.affaire.client.impaye') active @endif" 
              ...
              <div class="nav-item">
                <a  class="nav-link dropdown-toggle 
                          @if(Route::currentRouteName() === 'comptable.bilan.semaine.facture.client' or Route::currentRouteName() === 'comptable.bilan.mois.facture.client' or Route::currentRouteName() === 'comptable.bilan.trimestre.facture.client' or Route::currentRouteName() === 'comptable.bilan.annee.facture.client'
                              or Route::currentRouteName() === 'comptable.bilan.semaine.facture.fournisseur' or Route::currentRouteName() === 'comptable.bilan.mois.facture.fournisseur' or Route::currentRouteName() === 'comptable.bilan.trimestre.facture.fournisseur' or Route::currentRouteName() === 'comptable.bilan.annee.facture.fournisseur'
                              or Route::currentRouteName() === 'comptable.bilan.semaine.depense.interne' or Route::currentRouteName() === 'comptable.bilan.mois.depense.interne' or Route::currentRouteName() === 'comptable.bilan.trimestre.depense.interne' or Route::currentRouteName() === 'comptable.bilan.annee.depense.interne'
                          ) active @endif
                    " 
                ...
                <div  id="BC" 
                      ...
                      data-bs-parent="#navbarVerticalMenuPagesMenu">
                  <a class="nav-link @if(Route::currentRouteName() === 'comptable.bilan.semaine.facture.client' or Route::currentRouteName() === 'comptable.bilan.mois.facture.client' or Route::currentRouteName() === 'comptable.bilan.trimestre.facture.client' or Route::currentRouteName() === 'comptable.bilan.annee.facture.client') active @endif" href="{{ route('comptable.bilan.semaine.facture.client') }}">Factures clients</a>
                  <a class="nav-link @if(Route::currentRouteName() === 'comptable.bilan.semaine.facture.fournisseur' or Route::currentRouteName() === 'comptable.bilan.mois.facture.fournisseur' or Route::currentRouteName() === 'comptable.bilan.trimestre.facture.fournisseur' or Route::currentRouteName() === 'comptable.bilan.annee.facture.fournisseur') active @endif" href="{{ route('comptable.bilan.semaine.facture.fournisseur') }}">Factures fournisseurs</a>
                  <a class="nav-link @if(Route::currentRouteName() === 'comptable.bilan.semaine.depense.interne' or Route::currentRouteName() === 'comptable.bilan.mois.depense.interne' or Route::currentRouteName() === 'comptable.bilan.trimestre.depense.interne' or Route::currentRouteName() === 'comptable.bilan.annee.depense.interne') active @endif" href="{{ route('comptable.bilan.semaine.depense.interne') }}">Dépenses internes</a>
                </div>
              </div>
              ...
              <div class="nav-item">
                <a class="nav-link  @if(Route::currentRouteName() === 'comptable.profil') active @endif" href="{{ route('comptable.profil') }}" data-placement="left">
                  <i class="bi-people nav-icon"></i>
