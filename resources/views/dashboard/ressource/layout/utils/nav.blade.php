          ...
          <li class="nav-item">
            ...
            <div class="dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-end navbar-dropdown-menu navbar-dropdown-menu-borderless navbar-dropdown-account" aria-labelledby="accountNavbarDropdown" style="width: 16rem;"><div class="dropdown-item-text">
                ...
                <a class="dropdown-item" href="{{ route('ressource.profil') }}"><i class="bi-people nav-icon"></i> Profil</a>
                <div class="dropdown-divider"></div>
                <form action="{{ route('ressource.logout') }}" method="post">
                @csrf
        ...
        <div class="navbar-vertical-content">
          <div id="navbarVerticalMenu" class="nav nav-pills nav-vertical card-navbar-nav">
            ...
            <div class="nav-item">
              ...
              <div id="navbarVerticalMenuDashboards" class="nav-collapse collapse @if(Route::currentRouteName() === 'ressource.home') show @endif" data-bs-parent="#navbarVerticalMenu">
                <a class="nav-link @if(Route::currentRouteName() === 'ressource.home') active @endif" href="{{ route('ressource.home') }}">Accueil</a>
              </div>
            </div>
            <!-- End Collapse -->
            ...
            <div id="navbarVerticalMenuPagesMenu">
              ...
              <div class="nav-item">
                <a class="nav-link @if(Route::currentRouteName() === 'ressource.projet') active @endif" href="{{ route('ressource.projet') }}" data-placement="left">
                  <i class="bi-people nav-icon"></i>
                  <span class="nav-link-title">Projet</span>
                </a>
              </div>

              <span class="dropdown-header mt-2">Les employés</span>
              <div class="nav-item">
                <a  class="nav-link dropdown-toggle @if(Route::currentRouteName() === 'ressource.employe.index' or Route::currentRouteName() === 'ressource.employe.create' or Route::currentRouteName() === 'ressource.employe.edit' or Route::currentRouteName() === 'ressource.employe.show' or Route::currentRouteName() === 'ressource.employedoc.show' or Route::currentRouteName() === 'ressource.employecontrat.show') active @endif" 
                    href="#navbarVerticalMenuPagesUsersMenu" role="button" data-bs-toggle="collapse" data-bs-target="#navbarVerticalMenuPagesUsersMenu" aria-expanded="false" aria-controls="navbarVerticalMenuPagesUsersMenu">
                  <i class="bi-people nav-icon"></i>
                  <span class="nav-link-title">Employés</span>
                </a>

                <div  id="navbarVerticalMenuPagesUsersMenu" 
                    class="nav-collapse collapse @if(Route::currentRouteName() === 'ressource.employe.index' or Route::currentRouteName() === 'ressource.employe.create' or Route::currentRouteName() === 'ressource.employe.edit' or Route::currentRouteName() === 'ressource.employe.show' or Route::currentRouteName() === 'ressource.employedoc.show' or Route::currentRouteName() === 'ressource.employecontrat.show') show @endif" 
                    data-bs-parent="#navbarVerticalMenuPagesMenu">
                  <a class="nav-link @if(Route::currentRouteName() === 'ressource.employe.index' or Route::currentRouteName() === 'ressource.employe.edit' or Route::currentRouteName() === 'ressource.employe.show' or Route::currentRouteName() === 'ressource.employedoc.show' or Route::currentRouteName() === 'ressource.employecontrat.show') active @endif" href="{{ route('ressource.employe.index') }}">Liste des employés</a>
                  <a class="nav-link @if(Route::currentRouteName() === 'ressource.employe.create') active @endif" href="{{ route('ressource.employe.create') }}">Ajouter</a>
                  <!-- <a class="nav-link @if(Route::currentRouteName() === 'ressource.employecontrat.index') active @endif" href="{{ route('ressource.employecontrat.index') }}">Suivre les contrats</a> -->
                </div>
              </div>
              
              <span class="dropdown-header mt-2">Liste de presence</span>
              <div class="nav-item">
                <a class="nav-link @if(Route::currentRouteName() === 'ressource.liste.presence' or Route::currentRouteName() === 'ressource.liste.presence.employe') active @endif" href="{{ route('ressource.liste.presence') }}" data-placement="left">
                  <i class="bi-people nav-icon"></i>
                  <span class="nav-link-title">Présence</span>
                </a>
              </div>
              
              <span class="dropdown-header mt-2">Demande de congé</span>
              <div class="nav-item">
                <a class="nav-link @if(Route::currentRouteName() === 'ressource.liste.presence' or Route::currentRouteName() === 'ressource.liste.presence.employe') active @endif" href="{{ route('ressource.liste.presence') }}" data-placement="left">
                  <i class="bi-people nav-icon"></i>
                  <span class="nav-link-title">Demande de congé</span>
                </a>
              </div>
              
              <span class="dropdown-header mt-2">Paiement des employé</span>
              <div class="nav-item">
                <a class="nav-link @if(Route::currentRouteName() === 'ressource.liste.presence' or Route::currentRouteName() === 'ressource.liste.presence.employe') active @endif" href="{{ route('ressource.liste.presence') }}" data-placement="left">
                  <i class="bi-people nav-icon"></i>
                  <span class="nav-link-title">Paiement des employé</span>
                </a>
              </div>
              
              <span class="dropdown-header mt-2">Liste des entretiens</span>
              <div class="nav-item">
                <a class="nav-link @if(Route::currentRouteName() === 'ressource.liste.presence' or Route::currentRouteName() === 'ressource.liste.presence.employe') active @endif" href="{{ route('ressource.liste.presence') }}" data-placement="left">
                  <i class="bi-people nav-icon"></i>
                  <span class="nav-link-title">Entretien</span>
                </a>
              </div>
              
              <span class="dropdown-header mt-2">Profil</span>
              <div class="nav-item">
                <a class="nav-link  @if(Route::currentRouteName() === 'ressource.profil') active @endif" href="{{ route('ressource.profil') }}" data-placement="left">
                  <i class="bi-people nav-icon"></i>
