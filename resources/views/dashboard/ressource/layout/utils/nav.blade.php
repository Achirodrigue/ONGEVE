            ...
            <div id="navbarVerticalMenuPagesMenu">
              ...
              <div class="nav-item">
                ...
                <div  id="navbarVerticalMenuPagesUsersMenu" 
                  ...
                  <a class="nav-link @if(Route::currentRouteName() === 'ressource.employecontrat.create') active @endif" href="{{ route('ressource.employecontrat.create') }}">Suivre les contrat</a>
                </div>
              </div>
              <!-- End Collapse -->
