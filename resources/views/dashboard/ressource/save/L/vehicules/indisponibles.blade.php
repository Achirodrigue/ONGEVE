    ...
    <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
        ...
        <a class="dropdown-item text-center small text-primary" href="">
            Voir toutes les demandes
                ...
                <h1 class="h3 mb-0 text-gray-800">Véhicules Non Disponibles</h1>
            ...
            <div class="col-md-4">
                <div class="card mb-4 shadow-sm">
                    ...
                    <div class="card-body">
                        ...
                        <a href="{{ route('vehicules.retourForm', $v->id) }}" class="btn btn-warning mt-2">Retourner</a>
                    </div>
                </div>
            </div>
        @empty
            <p>Aucun véhicule emprunté</p>
        @endforelse
    </div>
</div>
