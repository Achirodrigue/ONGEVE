...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
  <!-- Titre à gauche -->
  <h1 class="h3 mb-0 text-gray-800">Gardien</h1>

  <!-- Boutons à droite avec ESPACE entre eux -->
  <div class="d-flex gap-2">
    <a href="{{ route('vehicules.create') }}" class="btn btn-sm btn-primary shadow-sm">
      <i class="fas fa-plus fa-sm text-white-50"></i> Ajouter un véhicule
    </a>

    <button onclick="openModal()" class="btn btn-sm btn-primary shadow-sm">
      <i class="fas fa-qrcode fa-sm text-white-50"></i> Générer un QR Code
    </button>
  </div>
</div>
...
<script>
function openModal() {
    const url = "{{ url('/vehicules') }}"; // lien vers le formulaire Laravel
