              ...
              <div class="d-grid gap-3 gap-lg-5">
                ...
                <div class="card">
                  ...
                  <div class="card-header card-header-content-between">
                    <h4 class="card-header-title">Information magasinier</h4>
                  </div>
                  <!-- End Header -->

                  <!-- Body -->
                  <div class="card-body"><!--  card-body-height" style="height: 30rem;  -->
                    <form method="POST" action="{{ route('magasinier.profil.update') }}" enctype="multipart/form-data">
                      @csrf
                      @method('PATCH')
                          ...
                          <div class="card card-sm bg-dark border-dark mx-2">
                            <div class="card-body">
                              <div class="row justify-content-center justify-content-sm-between">
                                <div class="col">
                                  <a href="{{ route('magasinier.home') }}" class="btn btn-ghost-danger">Retour</a>
                                </div>
                                <!-- End Col -->
