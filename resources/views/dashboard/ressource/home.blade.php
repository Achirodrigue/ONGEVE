      ...
      <div class="row">
        <div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
          ...
          <a class="card card-hover-shadow h-100" href="#">
            <div class="card-body">
              <h6 class="card-subtitle">Nombre total des employés</h6>

              <div class="row align-items-center gx-2">
                <div class="col-6">
                  <h2 class="card-title text-inherit">{{ $employes->count() }}</h2>
                </div>
                <!-- End Col -->
        ...
        <div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
          ...
          <a class="card card-hover-shadow h-100" href="#">
            <div class="card-body">
              <h6 class="card-subtitle">Demande de congé en attente</h6>

              <div class="row align-items-center gx-2">
                <div class="col-6">
                  <h2 class="card-title text-inherit">{{ $demandeconges }}</h2>
                </div>
                <!-- End Col -->
            ...
            <div class="card-header card-header-content-between">
              ...
              <div class="dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-end mt-1" aria-labelledby="reportsOverviewDropdown1">
                  ...
                  <a class="dropdown-item" href="{{ route('ressource.projet') }}">
                ...
                <div class="table-responsive">
                  @foreach(projets()->take(8) as $projet)
                    ...
                    <div>
                      ...
                      <a href="{{ route('ressource.projet.tache', $projet) }}"><span class="fs-6 m-3"><i class="bi-people nav-icon"></i> {{ $projet->projettaches->count() }}</span></a>
