          ...
          <li class="nav-item">
            ...
            <div class="dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-end navbar-dropdown-menu navbar-dropdown-menu-borderless navbar-dropdown-account" aria-labelledby="accountNavbarDropdown" style="width: 16rem;"><div class="dropdown-item-text">
                ...
                <a class="dropdown-item" href="{{ route('magasinier.home') }}"><i class="bi-people nav-icon"></i> Profile</a>
                <div class="dropdown-divider"></div>
        ...
        <div class="navbar-vertical-content">
          <div id="navbarVerticalMenu" class="nav nav-pills nav-vertical card-navbar-nav">
            ...
            <div class="nav-item">
              ...
              <div id="navbarVerticalMenuDashboards" class="nav-collapse collapse @if(Route::currentRouteName() === 'magasinier.home') show @endif" data-bs-parent="#navbarVerticalMenu">
                <a class="nav-link @if(Route::currentRouteName() === 'magasinier.home') active @endif" href="{{ route('magasinier.home') }}">Accueil</a>
              </div>
            </div>
            <!-- End Collapse -->
            ...
            <div id="navbarVerticalMenuPagesMenu">
              ...
              <div class="nav-item">
                <a  class="nav-link @if(Route::currentRouteName() === 'magasinier.categorie.index' or Route::currentRouteName() === 'magasinier.categorie.create' or Route::currentRouteName() === 'magasinier.categorie.edit' or Route::currentRouteName() === 'magasinier.categorie.produit') active @endif" 
                    href="{{ route('magasinier.categorie.index') }}" data-placement="left">
              ...
              <div class="nav-item">
                <a  class="nav-link dropdown-toggle @if(Route::currentRouteName() === 'magasinier.stock.global.produit' or Route::currentRouteName() === 'magasinier.stock.global.produit.deux') active @endif" 
                ...
                <div  id="stock" 
                      class="nav-collapse collapse @if(Route::currentRouteName() === 'magasinier.stock.global.produit' or Route::currentRouteName() === 'magasinier.stock.global.produit.deux') show @endif" 
                      data-bs-parent="#navbarVerticalMenuPagesMenu">
                  <a class="nav-link @if(Route::currentRouteName() === 'magasinier.stock.global.produit') active @endif" href="#" data-bs-toggle="modal" data-bs-target="#entrepotProduit">Historique</a>
              ...
              <div class="nav-item">
                <a  class="nav-link dropdown-toggle @if(Route::currentRouteName() === 'magasinier.commande.client.valide' or Route::currentRouteName() === 'magasinier.commande.client.livre' or Route::currentRouteName() === 'magasinier.commande.particulier.valide' or Route::currentRouteName() === 'magasinier.commande.particulier.livre') active @endif" 
                ...
                <div  id="commande" 
                      class="nav-collapse collapse @if(Route::currentRouteName() === 'magasinier.commande.client.valide' or Route::currentRouteName() === 'magasinier.commande.client.livre' or Route::currentRouteName() === 'magasinier.commande.particulier.valide' or Route::currentRouteName() === 'magasinier.commande.particulier.livre') show @endif" 
                      data-bs-parent="#navbarVerticalMenuPagesMenu">
                  <a class="nav-link @if(Route::currentRouteName() === 'magasinier.commande.client.valide' or Route::currentRouteName() === 'magasinier.commande.client.livre') active @endif" href="{{ route('magasinier.commande.client.valide') }}">Commandes client</a>
                  <a class="nav-link @if(Route::currentRouteName() === 'magasinier.commande.particulier.valide' or Route::currentRouteName() === 'magasinier.commande.particulier.livre') active @endif" href="{{ route('magasinier.commande.particulier.valide') }}">Commandes entreprise</a>
                </div>
              </div>
              ...
              <div class="nav-item">
                <a class="nav-link  @if(Route::currentRouteName() === 'magasinier.profil') active @endif" href="{{ route('magasinier.profil') }}" data-placement="left">
