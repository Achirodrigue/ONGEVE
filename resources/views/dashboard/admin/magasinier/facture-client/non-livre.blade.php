      ...
      <div class="page-header">
        ...
        <div class="js-nav-scroller hs-nav-scroller-horizontal">
          ...
          <ul class="nav nav-tabs page-header-tabs" id="pageHeaderTab" role="tablist">
            ...
            <li class="nav-item">
              <a class="nav-link" href="{{ route('admin.facture.livre') }}" tabindex="-1" aria-disabled="true">
                Factures livrées
              </a>
            </li>
          </ul>
      ...
      <div class="card card-table">
          ...
          @else
              ...
              <div class="card-header card-header-content-md-between p-4">
                <h3 class="fw-bold mb-0 text-center">Désolé! Aucune facture client non livré sur la plateforme</h3>
              </div>
              <!-- End Header -->
          @endif
      </div>
