                  ...
                  @foreach($categories as $categorie)
                    <tr>
                      ...
                      <td class="text-center">
                        <a href="{{ route('admin.categorie.produit', $categorie) }}" class="btn btn-primary">{{ $categorie->produits()->count() }}</a>
                      </td>
                      <td class="text-warning">{{ prixCategorieProduit($categorie) }}</td>
                      <td class="text-center">
                        <div class="btn-group" role="group">
                          <a class="btn btn-white btn-sm" href="#" data-bs-toggle="modal" data-bs-target="#">
