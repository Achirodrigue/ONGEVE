      ...
      <div class="page-header">
        <div class="row align-items-center mb-3">
          <div class="col-sm mb-2 mb-sm-0">
            <h1 class="page-header-title">Factures finalisées sur la plateforme <span class="badge bg-soft-dark text-dark ms-2">{{ $fournisseurfacturecomptables->count() }}</span></h1>
          </div>

          <div class="col-auto">
            @if($fournisseurfacturecomptables->count() > 0)
              <a class="btn btn-primary" href="{{ route('fournisseur.facture.general.export', ['statut' => 1]) }}">
        ...
        <div class="js-nav-scroller hs-nav-scroller-horizontal">
          ...
          <ul class="nav nav-tabs page-header-tabs" id="pageHeaderTab" role="tablist">
            ...
            <li class="nav-item">
              <a class="nav-link" href="{{ route('admin.all.facture.fournisseur.partielle') }}" tabindex="-1" aria-disabled="true">
                Factures Partielle
      ...
      <div class="card card-table">
          ...
          @else
              ...
              <div class="card-header card-header-content-md-between p-4">
                <h3 class="fw-bold mb-0 text-center">Désolé! Aucune facture Finalisée disponible sur la plateforme</h3>
              </div>
              <!-- End Header -->
          @endif
      </div>
