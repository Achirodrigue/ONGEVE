                    ...
                    <tr>
                      ...
                      <td class="text-center">
                        <div class="btn-group" role="group">
                          <a class="btn btn-white btn-sm" @if($fournisseur->fournisseurfacturecomptables()->count() > 0) href="{{ route('admin.fournisseur.facture.impaye', $fournisseur) }}" @else href="#" @endif>
