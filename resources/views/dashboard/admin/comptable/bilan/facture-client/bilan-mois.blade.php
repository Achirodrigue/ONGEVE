      ...
      <div class="page-header">
        <div class="row align-items-center mb-3">
          <div class="col-sm mb-2 mb-sm-0">
            <h1 class="page-header-title">Bilans par mois des factures client sur la plateforme <span class="badge bg-soft-dark text-dark ms-2">{{ $clientdevis->count() }}</span></h1>
          </div>
        </div>
        <!-- End Row -->
          ...
          <div class="card card-table mb-5">
              ...
              @else
                  ...
                  <div class="card-header card-header-content-md-between p-4">
                    <h5 class="fw-bold mb-0 text-center">Désolé! Aucune facture disponible pour cet mois sur la plateforme</h5>
                  </div>
                  <!-- End Header -->
              @endif   
          </div>
