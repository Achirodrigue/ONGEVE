      ...
      <div class="page-header">
        ...
        <div class="js-nav-scroller hs-nav-scroller-horizontal">
          ...
          <ul class="nav nav-tabs page-header-tabs" id="pageHeaderTab" role="tablist">
            <li class="nav-item">
              <a class="nav-link" href="{{ route('admin.bilan.semaine.depense.interne') }}" tabindex="-1" aria-disabled="true">Bilans mensuels</a>
            </li>
            <li class="nav-item">
          ...
          <div class="card card-table mb-5">
              ...
              @else
                  ...
                  <div class="card-header card-header-content-md-between p-4">
                    <h5 class="fw-bold mb-0 text-center">Désolé! Aucune dépense interne disponible pour cet trimestre sur la plateforme</h5>
                  </div>
                  <!-- End Header -->
              @endif   
          </div>
