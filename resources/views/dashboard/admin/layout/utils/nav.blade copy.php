              ...
              <div class="dropdown-menu dropdown-menu-end dropdown-card navbar-dropdown-menu navbar-dropdown-menu-borderless" aria-labelledby="navbarAppsDropdown" style="width: 25rem;">
                <div class="card">
                  ...
                  <div class="card-body card-body-height">
                      ...
                      <a class="dropdown-item" href="{{ route('logistique.home') }}">
                        <div class="d-flex align-items-center">
                          <div class="flex-shrink-0">
        ...
        <div class="navbar-vertical-content">
          <div id="navbarVerticalMenu" class="nav nav-pills nav-vertical card-navbar-nav">
            ...
            <div id="navbarVerticalMenuPagesMenu">
              ...
              <div class="nav-item">
                <a class="nav-link @if(Route::currentRouteName() === 'comptable.home') active @endif" href="{{ route('comptable.home') }}" data-placement="left">
                  <i class="bi-people nav-icon"></i>
                  <span class="nav-link-title">Comptable</span>
                </a>
              </div>
              
              <div class="nav-item">
                <a class="nav-link @if(Route::currentRouteName() === 'commercial.home') active @endif" href="{{ route('commercial.home') }}" data-placement="left">
                  <i class="bi-people nav-icon"></i>
              ...
              <div class="nav-item">
                <a class="nav-link @if(Route::currentRouteName() === 'magasinier.home') active @endif" href="{{ route('magasinier.home') }}" data-placement="left">
                  <i class="bi-people nav-icon"></i>
                  <span class="nav-link-title">Magasinier</span>
                </a>
              </div>
              
              <div class="nav-item">
                <a class="nav-link @if(Route::currentRouteName() === 'logistique.home') active @endif" href="{{ route('logistique.home') }}" data-placement="left">
                  <i class="bi-people nav-icon"></i>
                  <span class="nav-link-title">Logistique</span>
                </a>
              </div>
              
              <div class="nav-item">
                <a class="nav-link @if(Route::currentRouteName() === 'ressource.home') active @endif" href="http://fonction-rh.test/" target="_blanc" data-placement="left">
                  <i class="bi-people nav-icon"></i>
