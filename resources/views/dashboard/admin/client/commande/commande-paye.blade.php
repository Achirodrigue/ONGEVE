      ...
      <div class="page-header">
        <div class="row align-items-center mb-3">
          <div class="col-sm mb-2 mb-sm-0">
            <h1 class="page-header-title">Commandes finalisées du client <span class="badge bg-soft-dark text-dark ms-2">{{ $client->nom }}</h1>
          </div>

          <div class="col-auto">
            @if($client->clientdevis->count() > 0)
              <a class="btn btn-primary" href="{{ route('client.facture.individuel.export', ['client' => $client->id, 'statut' => 1]) }}">
        ...
        <div class="js-nav-scroller hs-nav-scroller-horizontal">
          ...
          <ul class="nav nav-tabs page-header-tabs" id="pageHeaderTab" role="tablist">
            ...
            <li class="nav-item">
              <a class="nav-link" href="{{ route('admin.client.commande.partielle', $client) }}" tabindex="-1" aria-disabled="true">
                Factures Partielle
      ...
      <div class="card card-table">
          ...
          @else
              ...
              <div class="card-header card-header-content-md-between p-4">
                <h3 class="fw-bold mb-0 text-center">Désolé! Aucune commande payé pour ce client sur la plateforme</h3>
              </div>
              <!-- End Header -->
          @endif
      </div>
