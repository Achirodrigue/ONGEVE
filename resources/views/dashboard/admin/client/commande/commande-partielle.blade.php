      ...
      <div class="page-header">
        <div class="row align-items-center mb-3">
          <div class="col-sm mb-2 mb-sm-0">
            <h1 class="page-header-title">Commandes partiellement payé du client <span class="badge bg-soft-dark text-dark ms-2">{{ $client->nom }}</span></h1>

          </div>

          <div class="col-auto">
            @if($client->clientdevis->count() > 0)
              <a class="btn btn-primary" href="{{ route('client.facture.individuel.export', ['client' => $client->id, 'statut' => 2]) }}">
                <img class="avatar avatar-xss avatar-4x3 me-2" src="{{ asset("dashboard/assets/svg/brands/excel-icon.svg") }}" alt="Image Description">
                format excel
              </a>
            @endif
            <a class="btn btn-primary" href="{{ route('admin.client.index') }}">
        ...
        <div class="js-nav-scroller hs-nav-scroller-horizontal">
          ...
          <ul class="nav nav-tabs page-header-tabs" id="pageHeaderTab" role="tablist">
            <li class="nav-item">
              <a class="nav-link" href="{{ route('admin.client.commande.impaye', $client) }}" tabindex="-1" aria-disabled="true">
                Factures Impayées
            ...
            <li class="nav-item">
              <a class="nav-link" href="{{ route('admin.client.commande.paye', $client) }}" tabindex="-1" aria-disabled="true">
                Factures Finalisées
      ...
      <div class="card card-table">
                ...
                <tbody>
                  @foreach($clientdevis as $clientdevis)
                    <tr>
                      ...
                      <td class="fw-bold">@if($clientdevis->TD) Location @else Vente de produit @endif</td>
          ...
          @else
              ...
              <div class="card-header card-header-content-md-between p-4">
                <h3 class="fw-bold mb-0 text-center">Désolé! Aucune commande partiellement payé pour ce client sur la plateforme</h3>
              </div>
              <!-- End Header -->
          @endif
      </div>
