      ...
      <div class="page-header">
        <div class="row align-items-center mb-3">
          ...
          <div class="col-auto">
            @if($clientdevis->count() > 0)
              <a class="btn btn-primary" href="{{ route('client.facture.general.export', ['statut' => 2]) }}">
        ...
        <div class="js-nav-scroller hs-nav-scroller-horizontal">
          ...
          <ul class="nav nav-tabs page-header-tabs" id="pageHeaderTab" role="tablist">
            <li class="nav-item">
              <a class="nav-link" href="{{ route('admin.commande.client.impaye') }}" tabindex="-1" aria-disabled="true" href="#">
                Factures Impayées
            ...
            <li class="nav-item">
              <a class="nav-link" href="{{ route('admin.commande.client.paye') }}" tabindex="-1" aria-disabled="true">
                Factures Finalisées
