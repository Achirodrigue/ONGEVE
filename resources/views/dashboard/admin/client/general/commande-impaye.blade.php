      ...
      <div class="page-header">
        <div class="row align-items-center mb-3">
          ...
          <div class="col-auto">
            @if($clientdevis->count() > 0)
              <a class="btn btn-primary" href="{{ route('client.facture.general.export', ['statut' => 0]) }}">
        ...
        <div class="js-nav-scroller hs-nav-scroller-horizontal">
          ...
          <ul class="nav nav-tabs page-header-tabs" id="pageHeaderTab" role="tablist">
            ...
            <li class="nav-item">
              <a class="nav-link" href="{{ route('admin.commande.client.partielle') }}" tabindex="-1" aria-disabled="true">
                Factures Partielle
