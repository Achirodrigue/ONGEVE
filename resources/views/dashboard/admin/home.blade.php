            ...
            <div class="card-header card-header-content-between">
              ...
              <div class="dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-end mt-1" aria-labelledby="reportsOverviewDropdown1">
                  ...
                  <a class="dropdown-item" href="{{ route('admin.projet') }}">
                ...
                <div class="table-responsive">
                  @foreach(projets()->take(8) as $projet)
                    ...
                    <div>
                      ...
                      <a href="{{ route('admin.projet.tache', $projet) }}"><span class="fs-6 m-3"><i class="bi-people nav-icon"></i> {{ $projet->projettaches->count() }}</span></a>
