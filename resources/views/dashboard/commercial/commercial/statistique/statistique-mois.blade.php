      ...
      <div class="page-header">
        <div class="row align-items-center mb-3">
          <div class="col-sm mb-2 mb-sm-0">
            <h1 class="page-header-title">Facture du commercial <span class="text-danger">{{ $commercial->nom }} {{ $commercial->prenom }}</span> de {{ $monthName }} {{ $year }} <span class="badge bg-soft-dark text-dark ms-2">{{ $clientdevis->count() }}</span></h1>
          </div>
           
          <div class="col-auto">
            <a class="btn btn-primary" href="{{ route('commercial.commercial.statistique.annee', ['commercial'=> $commercial, 'year' => $year]) }}">
