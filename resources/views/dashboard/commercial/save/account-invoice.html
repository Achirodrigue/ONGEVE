...
<!-- Mirrored from htmlstream.com/preview/front-dashboard-v2.1.1/account-invoice.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 01 Nov 2024 10:29:07 GMT -->
<head>
            ...
            <div id="navbarVerticalMenuPagesMenu">
              ...
              <div class="nav-item">
                ...
                <div id="navbarVerticalMenuPagesAccountMenu" class="nav-collapse collapse show" data-bs-parent="#navbarVerticalMenuPagesMenu">
                  ...
                  <a class="nav-link active" href="account-invoice.html">Invoice</a>
                </div>
              </div>
              <!-- End Collapse -->
      ...
      <div class="page-header d-print-none">
        <div class="row align-items-end">
          ...
          <div class="col-sm-auto">
            <a class="btn btn-primary" href="apps-invoice-generator.html">
