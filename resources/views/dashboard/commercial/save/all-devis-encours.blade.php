                ...
                <tbody>
                  @foreach(clientdevis() as $clientdevis)
                    <tr>
                      ...
                      <td class="fw-bold">{{ $clientdevis->client->prenom }}</td>
                      <td class="fw-bold">{{ $clientdevis->client->email }}</td>
                      <td class="fw-bold">{{ $clientdevis->client->contact }}</td>
                      <td class="fw-bold">{{ $clientdevis->numero_devis }}</td>
                      <td class="fw-bold">{{ getprice($clientdevis->total_ttc) }}</td>
                      <td class="fw-bold">{{ $clientdevis->date_expiration }}</td>
                      <td class="fw-bold">{{ $clientdevis-> }}</td>
                      <td class="fw-bold">{{ $clientdevis-> }}</td>
