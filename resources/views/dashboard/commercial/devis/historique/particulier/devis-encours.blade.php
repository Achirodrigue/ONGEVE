      ...
      <div class="page-header">
        <div class="row align-items-center mb-3">
          <div class="col-sm mb-2 mb-sm-0">
            <h1 class="page-header-title">Nombre de devis entreprise en cours <span class="badge bg-soft-dark text-dark ms-2">{{ $particulierdevis->count() }}</span></h1>
          </div>
          <!-- End Col -->

          <div class="col-auto">
            <a class="btn btn-primary" href="{{ route('commercial.devis.client.encours') }}">
              <i class="bi-arrow-return-left me-1"></i> Devis Particulier en cours
            </a>
          </div>
          <!-- End Col -->
        </div>
      ...
      <div class="card">
              ...
              <table id="datatable" class="table table-bordered table-hover table-borderless table-thead-bordered table-nowrap table-align-middle card-table" style="width: 100%" data-hs-datatables-options='{
                ...
                <tbody>
                  @foreach($particulierdevis as $particulierdevis)
                    <tr>
                      <td class="fw-bold">{{ $particulierdevis->particulier->nom }} {{ $particulierdevis->particulier->prenom }}</td>
                      <td class="fw-bold">{{ $particulierdevis->particulier->email }}</td>
                      <td class="fw-bold">{{ $particulierdevis->particulier->contact }}</td>
                      <td class="fw-bold">{{ $particulierdevis->numero_devis }}</td>
                      <td class="fw-bold">@if($particulierdevis->delai_livraison) {{ $particulierdevis->delai_livraison }} @else En cours @endif</td>
                      <td class="fw-bold">{{ getprice($particulierdevis->tva) }}F</td>
                      <td class="fw-bold">{{ $particulierdevis->total_ttc + $particulierdevis->frais + $particulierdevis->tva }}</td>
                      <td class="fw-bold">@if($particulierdevis->frais) {{ getprice($particulierdevis->frais) }} F @else En cours @endif</td>
                      <td>
                          ...
                          <div class="btn-group">
                            ...
                            <div class="dropdown-menu dropdown-menu-end mt-1" aria-labelledby="productsEditDropdown1">
                              ...
                              @if($particulierdevis->particulierdevisprods()->count() > 0)
                                ...
                                <a class="dropdown-item" href="{{ route('pdf.devis.commande.particulier', $particulierdevis) }}" target="_blank">
          ...
          @else
              ...
              <div class="card-header card-header-content-md-between p-4">
                <h3 class="fw-bold mb-0 text-center">Désolé! Aucun devis d'entreprise n'a été ajouté sur la plateforme</h3>
              </div>
              <!-- End Header -->
          @endif
      </div>
