...
<main id="content" role="main" class="main">
    ...
    <div class="content container-fluid">
      ...
      <div class="page-header">
        <div class="row align-items-center mb-3">
          <div class="col-sm mb-2 mb-sm-0">
            <h1 class="page-header-title">Évolution des devis - Commercial <span class="badge bg-soft-dark text-dark ms-2"></span></h1>
          </div>
      ...
      {{-- Sélecteur d'année --}}
      <form method="GET" action="{{ route('commercial.statistique.annee') }}" class="mb-4">
            ...
            <table id="datatable" class="table table-bordered table-hover table-borderless table-thead-bordered table-nowrap table-align-middle card-table" style="width: 100%" data-hs-datatables-options='{
              ...
              <tbody>
                @foreach($chartData as $monthName => $total)
                    @php
                        $monthNumber = \Carbon\Carbon::createFromFormat('F', $monthName, 'fr')->month;
                    @endphp
                    <tr>
                      <td>
                      ...
                      <td class="text-center fw-bold">
                        <div class="btn-group" role="group">
                          @if($total > 0)
                            <a class="btn btn-white btn-sm" href="{{ route('commercial.statistique.mois', [$selectedYear, $monthNumber]) }}">
