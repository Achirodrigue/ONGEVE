...
<main id="content" role="main" class="main">
    ...
    <div class="content container-fluid">
      ...
      <div class="row">
        <div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
          ...
          <a class="card card-hover-shadow h-100" href="#">
            <div class="card-body">
              <h6 class="card-subtitle">Nombre de devis généré en cours</h6>
              ...
              <span class="badge bg-soft-danger text-danger">
                <i class="bi-graph-down"></i> {{ getpricefr($DevisMT) }}
              </span>
            </div>
          </a>
          <!-- End Card -->
        ...
        <div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
          ...
          <a class="card card-hover-shadow h-100" href="#">
            <div class="card-body">
              <h6 class="card-subtitle">Nombre de client ajouté</h6>

              <div class="row align-items-center gx-2">
                <div class="col-6">
                  <h2 class="card-title text-inherit">{{ $AuthClients->count() }} / {{ $clients->count() }}</h2>
                </div>
                <!-- End Col -->
        ...
        <div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
          ...
          <a class="card card-hover-shadow h-100" href="#">
            <div class="card-body">
              ...
              <div class="row align-items-center gx-2">
                <div class="col-6">
                  <h2 class="card-title text-inherit">{{ getprice($FactureMT) }}F</h2>
                </div>
                <!-- End Col -->
        ...
        <div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
          ...
          <a class="card card-hover-shadow h-100" href="#">
            <div class="card-body">
              <h6 class="card-subtitle">Montant des factures payé</h6>

              <div class="row align-items-center gx-2">
                <div class="col-6">
                  <h2 class="card-title text-inherit">{{ getprice($FactureCA) }}F</h2>
                </div>
                <!-- End Col -->
      ...
      <div class="card card-table mb-3 mb-lg-5">
        @if($AuthClients->count() > 0)
            <!-- Header -->
            <div class="card-header">
              <div class="row justify-content-between align-items-center flex-grow-1">
                <div class="col-md">
                  <div class="d-flex justify-content-between align-items-center">
                    <h4 class="card-header-title">Clients ajoutés</h4>
