    ...
    <div class="content container-fluid">
      ...
      <div class="page-header">
        <div class="row align-items-center">
          <div class="col">
            <h1 class="page-header-title">Mes differentes statistiques statistiques</h1>
          </div>
          <!-- End Col -->
      ...
      <div class="row">
        <div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
          ...
          <a class="card card-hover-shadow h-100" href="#">
            <div class="card-body">
              <h6 class="card-subtitle">Nombre de devis traiter</h6>
              ...
              <!-- <span class="badge bg-soft-success text-success">
                <i class="bi-graph-up"></i> {{ $clientdevis->count() }}
              </span>
        ...
        <div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
          ...
          <a class="card card-hover-shadow h-100" href="#">
            <div class="card-body">
              <h6 class="card-subtitle">Nombre de commande traiter</h6>
              ...
              <!-- <span class="badge bg-soft-success text-success">
                <i class="bi-graph-up"></i> {{ $clientcommandes->count() }}
              </span>
