      ...
      <div class="page-header">
        <div class="row align-items-center mb-3">
          <div class="col-sm mb-2 mb-sm-0">
            <h1 class="page-header-title">Nombre de factures client partiellement payés <span class="badge bg-soft-dark text-dark ms-2">{{ $clientdevis->count() }}</span></h1>
          </div>
        </div>
        <!-- End Row -->
        ...
        <div class="js-nav-scroller hs-nav-scroller-horizontal">
          ...
          <ul class="nav nav-tabs page-header-tabs" id="pageHeaderTab" role="tablist">
            <li class="nav-item">
              <a class="nav-link" href="{{ route('commercial.facture.client.impaye') }}" tabindex="-1" aria-disabled="true" href="#">
                Factures Impayées
                <span class="badge bg-soft-dark text-dark rounded-pill ms-1">{{ ComCFIG() }}</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link active">
                Factures Partielle
                <span class="badge bg-soft-dark text-dark rounded-pill ms-1">{{ ComCFPTG() }}</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="{{ route('commercial.facture.client.paye') }}" tabindex="-1" aria-disabled="true">
                Factures Finalisées
                <span class="badge bg-soft-dark text-dark rounded-pill ms-1">{{ ComCFPYG() }}</span>
              </a>
            </li>
          </ul>
          <!-- End Nav -->
