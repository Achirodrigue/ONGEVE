  <!-- Choix type devis Modal -->
  <div class="modal fade" id="typeDevis" tabindex="-1" aria-labelledby="createAKIKeyModalLabel" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header mb-3">
          <h4 class="modal-title" id="createAKIKeyModalLabel">Choisir le destinataire du devis</h4>
          ...
          <div class="row align-items-sm-center flex-grow-1 mx-n2 justify-content-end" style="justify-content: space-around !important;">
            <div class="col-sm-auto">
              <div class="d-flex gap-3">
                <a href="{{ route('commercial.devis.client.create') }}" class="btn btn-white">Pour un particulier</a>
                <a href="{{ route('commercial.devis.particulier.create') }}" class="btn btn-primary">Pour une entreprise</a>
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="col-sm-auto">
              <div class="d-flex gap-3" style="flex-wrap: wrap; align-items: center; justify-content: space-between;">
                @foreach(categories() as $categorie)
                  <a href="{{ route('commercial.stock.global.produit', $categorie) }}" class="btn btn-white">{{ $categorie->nom }}</a>
                @endforeach
              </div>
            </div>
          </div>
