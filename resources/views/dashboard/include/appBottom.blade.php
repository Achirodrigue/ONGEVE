    ...
    <!-- js .... -->
        ...
        <script>
            function PorSP() {
                const select = document.getElementById("PouSP");
        ...
        <script>
            function PorSPprod() {
                const select = document.getElementById("PouSPprod");
                const PeriodeProd = document.getElementById("PeriodeProd");
                
                if (select.value === "P") {
                    PeriodeProd.style.display = "block";
                } else {
                    PeriodeProd.style.display = "none";
                }
            }
