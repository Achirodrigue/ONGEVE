    ...
    <div class="invoice-a4 position-relative">
      ...
      <div class="text-end">
        <div class="kv">
          ...
          @if(!$clientdevisavoir->clientdevis->client->TC)
            <div>N°CC @if($clientdevisavoir->clientdevis->client->NCC) {{ $clientdevisavoir->clientdevis->client->NCC }} @else : Aucun @endif</div>
          @endif
