      ...
      <table class="table table-sm w-100 ms-auto totals" style="width: 100%;">
        @if($clientdevis->TDF == 1)
            <tbody>
              <tr>
                ...
                <td class="gras-td">Nbre jours</td>
        ...
        @elseif($clientdevis->TDF == 2)
            <tbody>
              <tr>
                <td class="gras-td">Désignation</td>
                <td class="gras-td">Nbre passages</td>
                <td class="gras-td">PU (Fcfa)</td>
                <td class="gras-td">Total (Fcfa)</td>
              </tr>
              @foreach ($clientdevis->clientdevisprestations as $clientdevisprestation)
                <tr>
                  ...
                  <td>{{ getprice($clientdevisprestation->prix_total) }}</td>
                </tr>
              @endforeach
            </tbody>
        @else
