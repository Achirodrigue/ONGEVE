              ...
              <table id="datatable" class="table table-bordered table-hover table-borderless table-thead-bordered table-nowrap table-align-middle card-table" style="width: 100%" data-hs-datatables-options='{
                ...
                <tbody>
                  @foreach($fournisseurfacturecomptables as $fournisseurfacturecomptable)
                    <tr>
                      ...
                      <td>
                        <div class="btn-group" role="group">
                          ...
                          <!-- Button Group -->
                          <div class="btn-group">
                            <button type="button" class="btn btn-white btn-icon btn-sm dropdown-toggle dropdown-toggle-empty" id="productsEditDrop{{ $fournisseurfacturecomptable->id }}down" data-bs-toggle="dropdown" aria-expanded="true"></button>

                            <div class="dropdown-menu dropdown-menu-top mt-1" aria-labelledby="productsEditDrop{{ $fournisseurfacturecomptable->id }}down">                            
                              
                              <a class=" dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#editfournisseurfacturecomptable{{ $fournisseurfacturecomptable->id }}">
                                <i class="bi-pencil-fill me-1 dropdown-item-icon"></i> Facture
                              </a>
                              <a class=" dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#deletefournisseurfacturecomptable{{ $fournisseurfacturecomptable->id }}">
                                <i class="bi-trash me-1 dropdown-item-icon"></i> Facture
                              </a>
                              <a class=" dropdown-item" href="{{ route('geststock.fournisseur.facture.add.produit', $fournisseurfacturecomptable) }}">
                    ...
                    @include('include.commun.fournisseur-facture')
                  @endforeach
                </tbody>
              </table>
            </div>
