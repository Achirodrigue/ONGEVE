      ...
      <div class="page-header">
        <div class="row align-items-center mb-3">
          <div class="col-sm mb-2 mb-sm-0">
            <h1 class="page-header-title">Ajout de produit dans la facture {{ $fournisseurfacturecomptable->numero_facture }} du fournisseur
              <span class="badge bg-soft-dark text-dark ms-2">{{ $fournisseurfacturecomptable->fournisseur->nom }}</span>
            </h1>
          </div>
          <!-- End Col -->
          @if($fournisseurfacturecomptable->fournisseurfps()->count() > 0)
            <!-- <div class="col-auto">
              <a class="btn btn-primary" target="_blank" href="{{ route('pdf.devis.commande.client', $fournisseurfacturecomptable) }}">
                <i class="bi-file-earmark-arrow-down me-1"></i> PDF
              </a>
            </div> -->
            <!-- <div class="col-auto">
              <a class="btn btn-primary" href="{{ route('geststock.facture.fournisseur.detail', $fournisseurfacturecomptable) }}">
          ...
          @if($fournisseurfacturecomptable->fournisseurfps()->count() > 0)
            ...
            <div class="table-responsive datatable-custom">
              <table class="table table-bordered table-hover table-borderless table-thead-bordered table-nowrap table-align-middle card-table" style="width: 100%" data-hs-datatables-options='{
                ...
                <tbody>
                  @foreach($fournisseurfacturecomptable->fournisseurfps as $clientdevisprod)
                    <tr>
                      <td>
