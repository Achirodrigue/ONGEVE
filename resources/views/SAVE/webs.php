    ...
    Route::prefix('/gestionnnaire/stock')->middleware('auth:geststock')->name('geststock.')->group(function(){
        ...
        //fournisseur facture
            ...
            //creation
                ...
                // Route::get('/facture/fournisseur/produit/{fournisseurfacture}' , [GeststockFournisseurFactureController::class,'factureFournisseurProduit'])->name('facture.fournisseur.produit');
                // Route::post('/facture/fournisseur/ajout/produit/{fournisseurfacture}/{produit}' , [GeststockFournisseurFactureController::class,'factureFournisseurAddProduit'])->name('facture.fournisseur.add.produit');
                // Route::update('/facture/fournisseur/edit/produit/{fournisseurfactureprod}' , [GeststockFournisseurFactureController::class,'factureFournisseurEditProduit'])->name('facture.fournisseur.edit.produit');
                // Route::get('/facture/fournisseur/destroy/produit/{fournisseurfactureprod}' , [GeststockFournisseurFactureController::class,'factureFournisseurDestroyProduit'])->name('facture.fournisseur.destroy.produit');
                // Route::patch('/facture/fournisseur/update/{fournisseurfacture}' , [GeststockFournisseurFactureController::class,'factureFournisseurUpdate'])->name('facture.fournisseur.update');
            //
        //
        //fournisseur facture
