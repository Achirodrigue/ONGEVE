    <!-- Modal delete-->
    <div class="modal fade" id="deleteSousCategorie{{ $scategorie->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <!-- Modal modif -->
    <div class="modal fade" id="editSousCategorie{{ $scategorie->id }}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
