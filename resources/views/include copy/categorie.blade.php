        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Voulez-vous vraiment supprimer la catégorie <span class="fw-bold">{{ $categorie->nom }}</span> ??</p>
                </div>
    ...
    <!-- Modal modif -->
    <div class="modal fade" id="editCategorie{{ $categorie->id }}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="staticBackdropLabel">Modifier la catégorie {{ $categorie->nom }} </h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form method="post" action="{{ route('admin.categorie.update', $categorie) }}" enctype="multipart/form-data">
                @csrf
                @method('PATCH')
                    <div class="modal-body">
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="nom" value="{{ $categorie->nom }}" id="category-title" class="form-control" required>
