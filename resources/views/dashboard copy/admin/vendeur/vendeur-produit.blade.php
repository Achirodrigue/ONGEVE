                                             ...
                                             <div>
                                                  <ol class="breadcrumb mb-0">
                                                       <li class="breadcrumb-item fw-medium"><a
                                                                 ...
                                                                 class="text-dark">Liste des produits du commerçant <span class="text-warning">{{ $vendeur->nom }} {{ $vendeur->prenom }}</span></a></li>
                                                  </ol>
                                             </div>
                                   ...
                                   <div class="card p-2">
                                        <div class="card-header border-0">
                                             <h4 class="fw-bold text-center">
                                                  Désolé! Aucun produit pour le commerçant <span class="text-warning">{{ $vendeur->nom }} {{ $vendeur->prenom }}</span>.
                                             </h4>
                                        </div>
                                   </div>
                              </div>
