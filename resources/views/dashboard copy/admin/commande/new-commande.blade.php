               ...
               <div class="row">
                    <div class="col-xl-12">
                         <div class="card">
                              ...
                              <div class="card-body">
                                   @if($commandesecteurs->count() > 0 && TNC() > 0)
                                             ...
                                             <table class="table table-hover table-centered">
                                                  ...
                                                  <tbody>
                                                       ...
                                                       @foreach($commandesecteurs as $commandesecteur)
                                                            @if(!$commandesecteur->commande->commandelivreur && !$commandesecteur->commande->isvalide)
                                                                 <tr>
                                                                      <td>
                                                                      ...
                                                                      <td>
                                                                           ...
                                                                           <div class="dropdown">
                                                                                ...
                                                                                <div class="dropdown-menu dropdown-menu-end" data-popper-placement="bottom-end" style="position: absolute; inset: 0px 0px auto auto; margin: 0px; transform: translate3d(0px, 22.4px, 0px);">
                                                                                     ...
                                                                                     <a href="{{ route('admin.pdf.commande', $commandesecteur->commande) }}" class="dropdown-item" target="_blank">
