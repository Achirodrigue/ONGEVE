               ...
               <div class="container-xxl">
                    <div class="card">
                              ...
                              <div class="d-flex flex-wrap align-items-center justify-content-between gap-3">
                                   <div>
                                        <h5 class="card-title mb-1 anchor" id="responsive">
                                             Ajouter une astuce ou un conseil <a class="anchor-link" href="#responsive">#</a>
                                        </h5>
                                   </div>
                                   <div>
                         ...
                         <div class="card-body">
                              ...
                              <form method="POST" action="{{ route('admin.conseilastuce.store') }}" enctype="multipart/form-data">
                              @csrf
                                   <div class="row mb-3">
                                        <div class="col-lg-12">
                                             <div class="mb-3">
                                                  <label for="titre" class="form-label">Titre *</label>
                                                  <input type="text" name="titre" id="titre" value="{{ old('titre') }}" class="form-control" placeholder="Entrer un titre" required>
                                        ...
                                        <div class="col-lg-12">
                                             <div class="mb-3">
                                                  ...
                                                  <textarea name="contenu" class="form-control bg-light-subtle" id="contenu" rows="7"
                                                       placeholder="entrer un contenu" value="{{ old('contenu') }}" required></textarea>
                                                  @error('contenu') <span class="text-danger"> {{ $message }} </span> @enderror
                                             </div>
                                        </div>
                                        <div class="col-lg-6 mb-3">
                                             <label for="crater" class="form-label">Modele *</label>
                                             <select name="type" class="form-control" id="crater" data-choices data-choices-groups
