                              ...
                              <div class="d-flex flex-wrap align-items-center justify-content-between gap-3">
                                   <div>
                                        <h5 class="card-title mb-1 anchor" id="responsive">
                                             Ajouter un administrateur <a class="anchor-link" href="#responsive">#</a>
                                        </h5>
                                   </div>
                                   <div>
                              ...
                              @csrf
                                   <div class="row mb-3">
                                        ...
                                        <div class="col-lg-6 mb-3">
                                             ...
                                             <select name="role" id="monSelect" onchange="toggleInput()" required class="form-control" id="crater" data-choices data-choices-groups
                                        ...
                                        <div class="col-lg-6 mb-3" id="monInput">
