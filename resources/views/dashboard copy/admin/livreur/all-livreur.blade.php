                                   ...
                                   <div class="d-flex flex-wrap align-items-center justify-content-between gap-3">
                                        <div>
                                             <h5 class="card-title mb-1 anchor" id="responsive">
                                                  Mes différents livreurs de la plateformes <a class="anchor-link" href="#responsive">#</a>
                                             </h5>
                                        </div>
                                        <div>
                                             ...
                                             <table class="table table-hover table-centered">
                                                  <thead class="table-light">
                                                       <tr>
                                                            ...
                                                            <th scope="col">Livraison en cours</th>
                                                  ...
                                                  <tbody>
                                                       ...
                                                       @foreach($livreurs as $livreur)
                                                            <tr>
                                                                 ...
                                                                 <td>{{ $livreur->email }}</td>
                                                                 <td>{{ $livreur->admin->nom }} {{ $livreur->admin->prenom }}</td>
                                                                 <td>{{ $livreur->adresse }}</td>
                                                                 <td>
                                                                      <span>
                                                                           <a   @if($livreur->commandelivreurs->where('isvalide', 0)->count() > 0)
                                                                                     href="{{ route('admin.livreur.livraison.encours', $livreur) }}" class="btn btn-sm btn-light"
                                                                                @else
                                                                                     href="#" class="btn btn-sm btn-danger"
                                                                                @endif
                                                                           >
                                                                           @if($livreur->commandelivreurs->where('isvalide', 0)->count() > 0) 
                                                                                {{ $livreur->commandelivreurs->where('isvalide', 0)->count() }} 
                                                                           @else Aucune @endif
                                                                           </a>
                                                                      </span>
                                                                 </td>
                                                                 ...
                                                                 <!-- <td>                                                                 
                                                                      <button type="button" class="btn btn-sm btn-soft-warning px-3 fw-bold">{{ $livreur->commandelivreurs->where('isvalide', 0)->count() }}</button>
                                                                 </td> -->
                                                                 <td>
                                                                      <div class="dropdown">
                                                                           ...
                                                                           <div class="dropdown-menu dropdown-menu-end" data-popper-placement="bottom-end" style="position: absolute; inset: 0px 0px auto auto; margin: 0px; transform: translate3d(0px, 22.4px, 0px);">
                                                                                <a href="{{ route('admin.livreur.edit', $livreur) }}" class="dropdown-item">
                                                                                     <i class="bx bx-edit fs-16"></i> Modifier
                                                                                </a>
                                                                                <a href="#" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#deleteLivreur{{ $livreur->id }}">
