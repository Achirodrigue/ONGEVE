                                                ...
                                                <ol class="breadcrumb mb-0">
                                                    <li class="breadcrumb-item fw-medium">
                                                        <h4 class="text-dark mb-0">
                                                            Mes différentes formations lancées sur la plateforme
                                                        </h4>
                                                    </li>
                                                </ol>
                                            </div>
                                            ...
                                            <div>
                                                <div class="d-flex flex-wrap gap-2">
                                                    ...
                                                    <a href="{{ route('admin.formation.terminer') }}" class="btn btn-primary">
                                                        <i class="bx bx-plus me-1"></i>Déjà finalisé
                                                    </a>
                                                    <a href="{{ route('admin.formation.formateur.encours') }}" class="btn btn-primary">
                                                        <i class='bx bxs-arrow-from-left me-1'></i> en cours d'execution
                                                    </a>
                                                </div>
                                            </div>
                                    </div>
                                            ...
                                            <div class="d-flex flex-wrap gap-2">
                                                ...
                                                <div class="btn-group" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Folder">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            ...
                                                            @if($formation->pformations->count())
                                                                <a class="dropdown-item" href="{{ route('admin.postulation.formation', $formation) }}">
                                                                    Postulation : Voir
                                                                </a>
                                                                <a href="#" class="dropdown-item" 
                                                                    @if(Auth()->user()->role) data-bs-toggle="modal" data-bs-target="#AffecterFormateurFormation{{ $formation->id }}" @endif >
                                                                    <i class="bx bxs-user-detail me-1"></i> Affecter un formateur
                                                                </a>
                                                            @endif
                                                        </div>
                                                </div>
                            ...
                            <div class="card p-2">
                                <div class="card-header border-0">
                                    <h4 class="fw-bold text-center">
                                        Désolé! Aucune formation en cours disponible sur la plateforme.
                                    </h4>
                                </div>
                            </div>
                        </div>
