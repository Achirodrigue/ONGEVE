                ...
                <div class="col-12">
                    <div class="row gi_breadcrumb_inner">
                        <div class="col-md-6 col-sm-12">
                            <h2 class="gi-breadcrumb-title">Nos formations</h2>
                        </div>
                        <div class="col-md-6 col-sm-12">
                            <!-- gi-breadcrumb-list start -->
                            <ul class="gi-breadcrumb-list">
                                <li class="gi-breadcrumb-item"><a href="{{ route('accueil') }}">Accueil</a></li>
                                <li class="gi-breadcrumb-item active">Formation</li>
                            </ul>
                        ...
                        <div class="gi-ofr-banners">
                            <div class="gi-bnr-body">
                                <div class="gi-bnr-img">
                                    ...
                                    <img src="{{ asset("principale/assets/img/perso/formation1.png") }}" alt="banner">
                                </div>
                        ...
                        <div class="gi-ofr-banners m-t-767">
                            <div class="gi-bnr-body">
                                <div class="gi-bnr-img">
                                    ...
                                    <img src="{{ asset("principale/assets/img/perso/img2.jpg") }}" alt="banner">
                                </div>
                                <!-- <div class="gi-bnr-detail">
                                                ...
                                                <div class="gi-product-inner">
                                                    <div class="gi-pro-image-outer">
                                                        <div class="gi-pro-image">
                                                            <a href="product-left-sidebar.html" class="image">
                                                                ...
                                                                <img class="main-image" src="{{ asset(Storage::url($formation->image)) }}"
                                                                    alt="Product">
                                                                <img class="hover-image" src="{{ asset(Storage::url($formation->image)) }}"
                                                                    alt="Product">
                                                            </a>
                                                            <span class="flags">
                                                            ...
                                                            <div class="gi-pro-actions">
                                                                <a href="{{ route('post.formation', $formation) }}" class="gi-btn-group compare"
                                                    ...
                                                    <div class="gi-pro-content">
                                                        <a href="shop-left-sidebar-col-3.html">
                                                            <h6 class="gi-pro-stitle">{{ $formation->nom }}</h6>
                                                        </a>
                                                        <h5 class="gi-pro-title"><a href="product-left-sidebar.html">
                                                        {{ $formation->description }}</a></h5>
                                                        <div class="gi-pro-rat-price">
                                                            <span class="gi-price">
                                                                <span class="new-price">Prix : {{ getprice($formation->prix) }}</span>
                                                            </span>
                                                        </div>
                                                        <div class="gi-pro-rat-price">
                                                            <span class="gi-price">
                                                                <span class="new-price">Date de debut : {{ dateFormate($formation->date_debut) }}</span>
                                                            </span>
                                                        </div>
                                                        <div class="gi-pro-rat-price">
                                                            <span class="gi-price">
                                                                <span class="new-price">Date de fin : {{ dateFormate($formation->date_fin) }}</span>
                                                            </span>
                                                        </div>
                                                        <div class="gi-pro-rat-price">
                                                            <span class="gi-price">
                                                                <span class="new-price">Lieu : {{ $formation->lieu }}</span>
                                                            </span>
                                                        </div>
                                                        <div class="gi-single-cart text-center mt-3">
                                                            <a href="{{ route('post.formation', $formation) }}">
                                                                <button class="btn btn-primary gi-btn-1">Postuler</button>
                                                            </a>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="gi-accordion style-1">
                                            <div class="gi-accordion-item">
                                                <h4 class="gi-accordion-header">
                                                    Désolé! Aucune formation n'à été publié pour le moment sur la plateforme
                                                </h4>
                                            </div>
                                        </div>
                                    </div>
