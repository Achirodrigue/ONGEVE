                ...
                <div class="col-12">
                    <div class="row gi_breadcrumb_inner">
                        <div class="col-md-6 col-sm-12">
                            <h2 class="gi-breadcrumb-title">Tout les Articles reconditionnés</h2>
                        </div>
                        <div class="col-md-6 col-sm-12">
                            <!-- gi-breadcrumb-list start -->
                            <ul class="gi-breadcrumb-list">
                                <li class="gi-breadcrumb-item"><a href="{{ route('accueil') }}">Accueil</a></li>
                                <li class="gi-breadcrumb-item active">Article reconditionné</li>
                            </ul>
                                        ...
                                        <div class="gi-accordion style-1">
                                            <div class="gi-accordion-item">
                                                <h4 class="gi-accordion-header">
                                                    Désolé! Aucun Article reconditionné n'à été publié pour le moment sur la plateforme
                                                </h4>
                                            </div>
                                        </div>
                                    </div>
