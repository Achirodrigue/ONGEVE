                ...
                <div class="col-12">
                    <div class="row gi_breadcrumb_inner">
                        <div class="col-md-6 col-sm-12">
                            <h2 class="gi-breadcrumb-title">Sous catégorie de produit : {{ $souscategorie->nom }}</h2>
                        </div>
                        <div class="col-md-6 col-sm-12">
                            <!-- gi-breadcrumb-list start -->
                            <ul class="gi-breadcrumb-list">
                                <li class="gi-breadcrumb-item"><a href="{{ route('accueil') }}">Accueil</a></li>
                                <li class="gi-breadcrumb-item active">{{ $souscategorie->nom }}</li>
                            </ul>
                    ...
                    <div class="shop-pro-content">
                        <div class="shop-pro-inner">
                            <div class="row">
                                ...
                                <div
                                    class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-xs-6 mb-6 gi-product-box pro-gl-content">
                            ...
                            <div class="gi-sidebar-block drop">
                                ...
                                @foreach(categories() as $categorie)  
                                    @php 
                                        ...
                                        if($ss > 0)
                                        {
                                            foreach($categorie->souscategories as $souscateg)
                                            {
                                                if($souscateg->produits->where('isvalide', 1)->count() > 0)
                                                {
                                                    $total++;
                                                }
                                            }
                                    ...
                                    @if($categorie->souscategories->count() > 0 && $total > 0)
                                        <div class="gi-sb-block-content pt-2">
                                            <ul>
                                                <li>
                                                    <a href="javascript:void(0)" class="gi-sidebar-block-item main drop">{{ $categorie->nom }}</a>
                                                    <ul @if($souscategorie->categorie->id === $categorie->id) style="display: block;" @endif>
                                                        @foreach($categorie->souscategories as $souscateg)  
                                                            @if($souscateg->produits->where('isvalide', 1)->count() > 0)  
                                                                <li>
                                                                    <div class="gi-sidebar-sub-item">
                                                                        <a href="{{ route('scategorie.produit', $souscateg) }}" @if($souscategorie->id === $souscateg->id) class="text-warning" @endif>
                                                                            {{ $souscateg->nom }}
                                                                            <span>{{ $souscateg->produits->where('isvalide', 1)->count() }}</span>
                                                                        </a>
                                                                    </div>
                                                                </li>
                                                            @endif
