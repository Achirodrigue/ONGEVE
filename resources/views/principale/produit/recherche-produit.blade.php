                ...
                <div class="col-12">
                    <div class="row gi_breadcrumb_inner">
                        <div class="col-md-6 col-sm-12">
                            <h2 class="gi-breadcrumb-title">Recherche d'article : {{ $produits->total() }} Résultat(s) pour la recherche "{{ request()->search }}"</h2>
                        </div>
                        <div class="col-md-6 col-sm-12">
                            <!-- gi-breadcrumb-list start -->
                            <ul class="gi-breadcrumb-list">
                                <li class="gi-breadcrumb-item"><a href="{{ route('accueil') }}">Accueil</a></li>
                                <li class="gi-breadcrumb-item active">Recherche</li>
                            </ul>
                                            ...
                                            <div class="gi-accordion style-1">
                                                <div class="gi-accordion-item">
                                                    <h4 class="gi-accordion-header">
                                                        Désolé! Aucun produit trouvé sur la plateforme pour la recherche : {{ request()->search }}
                                                    </h4>
                                                </div>
                                            </div>
                                        </div>
