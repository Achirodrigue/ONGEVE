...
<head>
    ...
    <title>Grabit - Multipurpose eCommerce HTML Template.</title>
    <meta name="keywords"
    ...
    <link rel="icon" href="{{ asset("principale/assets/img/favicon/favicon.png") }}" sizes="32x32">
...
<link rel="stylesheet" id="main_style" href="{{ asset("principale/assets/css/style.css") }}">
                ...
                <div class="row align-itegi-center">
                    ...
                    <div class="col header-top-right d-none d-lg-block">
                        <div class="header-top-right-inner d-flex justify-content-end">
                            <a class="gi-help" href="faq.html">Help?</a>
                            <a class="gi-help" href="track-order.html">Track Order?</a>
                            <!-- Language Start -->
                    ...
                    <div class="gi-flex">
                        ...
                        <div class="gi-header-action align-self-center">
                            <div class="gi-header-buttons">
                                ...
                                <!-- Header User End -->
                                <!-- Header wishlist Start -->
                                <a href="wishlist.html" class="gi-header-btn gi-wish-toggle" title="Wishlist">
                                    <div class="header-icon">
                                ...
                                <a href="javascript:void(0)" class="gi-header-btn gi-cart-toggle" title="Cart">
                                    ...
                                    <div class="gi-btn-desc">
                                        ...
                                        <span class="gi-btn-stitle"><b class="gi-cart-count">3</b>-items</span>
                                    </div>
                                </a>
                                <!-- Header Cart End -->
                            </div>
                    ...
                    <div class="gi-location-block">
                        <div class="gi-location-menu">
                            <div class="gi-location-toggle">
                                ...
                                <span class="gi-location-title d-1199 gi-location">New York</span>
                                <i class="fi-rr-angle-small-down d-1199 gi-angle" aria-hidden="true"></i>
                            </div>
    ...
    <div id="gi-side-cart" class="gi-side-cart">
        <div class="gi-cart-inner">
            ...
            <div class="gi-cart-bottom">
                ...
                <div class="cart_btn">
                    <a href="cart.html" class="gi-btn-1">View Cart</a>
                    <a href="checkout.html" class="gi-btn-2">Checkout</a>
                </div>
            </div>
        </div>
    </div>
                                ...
                                <div class="gi-product-content">
                                    <div class="gi-product-inner">
                                        ...
                                        <div class="gi-pro-content">
                                            ...
                                            <h5 class="gi-pro-title"><a href="product-left-sidebar.html">Natural Hub
                                                    Cherry Karonda</a></h5>
                                            <div class="gi-pro-rat-price">
                                                <span class="gi-pro-rating">
                                                    <i class="gicon gi-star fill"></i>
                                    ...
                                    <div class="gi-product-content">
                                        <div class="gi-product-inner">
                                            ...
                                            <div class="gi-pro-content">
                                                ...
                                                <h5 class="gi-pro-title"><a href="product-left-sidebar.html">Healthy
                                                        Nutmix,
                                                        200g Pack</a></h5>
                                                <div class="gi-pro-rat-price">
                                                    <span class="gi-pro-rating">
                                            ...
                                            <div class="gi-pro-image-outer">
                                                <div class="gi-pro-image">
                                                    <a href="product-left-sidebar.html" class="image">
                                                        ...
                                                        <img class="main-image" src="assets/img/product-images/26_1.jpg"
                                                            alt="Product">
                                                        <img class="hover-image"
                                            ...
                                            <div class="gi-pro-image-outer">
                                                <div class="gi-pro-image">
                                                    <a href="product-left-sidebar.html" class="image">
                                                        ...
                                                        <img class="main-image" src="assets/img/product-images/27_1.jpg"
                                                            alt="Product">
                                                        <img class="hover-image"
                                        ...
                                        <div class="gi-product-inner">
                                            ...
                                            <div class="gi-pro-content">
                                                ...
                                                <h5 class="gi-pro-title"><a
                                                        href="product-left-sidebar.html">Pineapple</a>
                                                </h5>
                                                <div class="gi-pro-rat-price">
                                                    <span class="gi-pro-rating">
                                                        <i class="gicon gi-star fill"></i>
                                            ...
                                            <div class="gi-pro-image-outer">
                                                <div class="gi-pro-image">
                                                    <a href="product-left-sidebar.html" class="image">
                                                        ...
                                                        <img class="main-image" src="assets/img/product-images/15_1.jpg"
                                                            alt="Product">
                                                        <img class="hover-image"
                                            ...
                                            <div class="gi-pro-image-outer">
                                                <div class="gi-pro-image">
                                                    <a href="product-left-sidebar.html" class="image">
                                                        ...
                                                        <img class="main-image" src="assets/img/product-images/16_1.jpg"
                                                            alt="Product">
                                                        <img class="hover-image"
                                            ...
                                            <div class="gi-pro-image-outer">
                                                <div class="gi-pro-image">
                                                    <a href="product-left-sidebar.html" class="image">
                                                        ...
                                                        <img class="main-image" src="assets/img/product-images/20_1.jpg"
                                                            alt="Product">
                                                        <img class="hover-image"
                    ...
                    <div class="row m-minus-991">
                            ...
                            <div class="gi-footer-widget">
                                ...
                                <div class="gi-footer-links gi-footer-dropdown">
                                    <ul class="align-itegi-center">
                                        <li class="gi-footer-link"><a href="shop-left-sidebar-col-3.html">Dairy &
                                                Milk</a></li>
                                        <li class="gi-footer-link"><a href="shop-banner-left-sidebar-col-3.html">Snack &
                                                Spice</a></li>
                                        <li class="gi-footer-link"><a href="shop-full-width-col-5.html">Fast Food</a>
                                        </li>
                                        <li class="gi-footer-link"><a href="shop-list-left-sidebar.html">Juice &
                                                Drinks</a></li>
                                        <li class="gi-footer-link"><a href="shop-list-full-col-2.html">Bakery</a></li>
                                        <li class="gi-footer-link"><a
                        ...
                        <div class="col-sm-12 col-lg-2 gi-footer-account wow fadeInUp" data-wow-delay="0.3s">
                            <div class="gi-footer-widget">
                                ...
                                <div class="gi-footer-links gi-footer-dropdown">
                                    <ul class="align-itegi-center">
                                        <li class="gi-footer-link"><a href="about-us.html">About us</a></li>
                                        <li class="gi-footer-link"><a href="track-order.html">Delivery</a></li>
                                        <li class="gi-footer-link"><a href="privacy-policy.html">Legal Notice</a></li>
                                        <li class="gi-footer-link"><a href="terms-condition.html">Terms & conditions</a>
                                        </li>
                                        <li class="gi-footer-link"><a href="checkout.html">Secure payment</a></li>
                                        <li class="gi-footer-link"><a href="contact-us.html">Contact us</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-12 col-lg-2 gi-footer-service wow fadeInUp" data-wow-delay="0.4s">
                            <div class="gi-footer-widget">
                                ...
                                <div class="gi-footer-links gi-footer-dropdown">
                                    <ul class="align-itegi-center">
                                        <li class="gi-footer-link"><a href="register.html">Sign In</a></li>
                                        <li class="gi-footer-link"><a href="cart.html">View Cart</a></li>
                                        <li class="gi-footer-link"><a href="privacy-policy.html">Return Policy</a></li>
                                        <li class="gi-footer-link"><a href="#">Become a Vendor</a></li>
                                        <li class="gi-footer-link"><a href="#">Affiliate Program</a></li>
                                        <li class="gi-footer-link"><a href="checkout.html">Payments</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-12 col-lg-3 gi-footer-cont-social wow fadeInUp" data-wow-delay="0.5s">
                            ...
                            <div class="gi-footer-social">
                                <div class="gi-footer-widget">
                                    <div class="gi-footer-links gi-footer-dropdown">
                                        <ul class="align-itegi-center">
                                            <li class="gi-footer-link"><a href="#"><i class="gicon gi-facebook"
                                                        aria-hidden="true"></i></a></li>
                                            <li class="gi-footer-link"><a href="#"><i class="gicon gi-twitter"
                                                        aria-hidden="true"></i></a></li>
                                            <li class="gi-footer-link"><a href="#"><i class="gicon gi-linkedin"
                                                        aria-hidden="true"></i></a></li>
                                            <li class="gi-footer-link"><a href="#"><i class="gicon gi-instagram"
                                                        aria-hidden="true"></i></a></li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="gi-bottom-info">
                            ...
                            <div class="footer-copy">
                                <div class="footer-bottom-copy ">
                                    <div class="gi-copy">Copyright © <a class="site-name" href="index.html">Grabit</a>
                                        all
                                        rights reserved. Powered by Grabit.</div>
                                </div>
                            </div>
...
<!-- Mirrored from maraviyainfotech.com/wrapbootstrap/grabit-html/grabit-html/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 04 Feb 2025 10:02:49 GMT -->
</html>