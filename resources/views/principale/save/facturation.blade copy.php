                                            ...
                                            <div class="gi-check-bill-form">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <span class="gi-bill-wrap gi-bill-half">
                                                            <label>Email *</label>
                                                            <input type="email" name="email" value="{{ old('email') }}" placeholder="Entrer votre email" require>
                                                    ...
                                                    <div class="col-md-6">
                                                        <span class="gi-bill-wrap gi-bill-half">
                                                            <label>Contact *</label>
                                                            <input type="number" minlength="8" maxlength="10" name="contact" value="{{ old('contact') }}" placeholder="Entrer votre contact" require>
                                                    ...
                                                    <div class="col-md-6"> 
                                                        <span class="gi-bill-wrap gi-bill-half">
                                                            ...
                                                            <input type="text" name="adresse_livraison" value="{{ old('adresse_livraison') }}" placeholder="Entrer votre adresse de livraison" name="adresse_livraison" required>
