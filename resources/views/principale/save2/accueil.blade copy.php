...
@section('body')
    ...
    <section class="section gi-hero m-tb-40 background" style="position: relative;">
    <div class="container">
        <div class="gi-main-content">

            <!-- ✅ BLOC UNIQUE, CENTRÉ EN HAUT DU CARROUSEL -->
            <div class="gi-slide-content text-center"
                 style="position: absolute; top: 0; left: 50%; transform: translateX(-50%); z-index: 1000; width: 100%; padding-top: 40px;">
                <p class="p-letter color">{{ \Carbon\Carbon::now()->translatedFormat('l d F Y') }}<b></b></p>
                ...
                <div class="gi-slide-btn mt-3">
                    <a href="#" class="gi-btn-1 background">Catalogue <i class="fi-rr-angle-double-small-right" aria-hidden="true"></i></a>
                </div>
            </div>
            ...
            <div class="gi-slider-content">
                <div class="gi-main-slider">
                    <div class="gi-slider swiper-container main-slider-nav main-slider-dot" style="padding-top: 180px;"> <!-- espace sous le texte -->
    ...
    <div class="container">
        <div class="gi-main-content">
            ...
            BLOC AFFICHÉ UNE SEULE FOIS EN HAUT 
            <div class="gi-slide-content text-center" style="position: absolute; z-index: 10;">
                <p class="p-letter color">{{ \Carbon\Carbon::now()->translatedFormat('l d F Y') }}<b></b></p>
                <h1 class="gi-slide-title text-uppercase">
                    <span class="color">Votre</span> 
                    <span class="ravmel-color4">boutique</span> 
