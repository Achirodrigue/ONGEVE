                ...
                <div class="gi-animated-banner" data-aos="fade-up" data-aos-duration="2000" data-aos-delay="200">
                    ...
                    <div class="gi-bnr-detail">
                        <div class="gi-bnr-info">
                            <h2>Des Articles en Promo à GOGO !</h2>
                            ...
                            <a href="#" class="gi-btn-2">Tout voir</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
                ...
                <div class="gi-ofr-banners">
                    <div class="gi-bnr-body">
                        <div class="gi-bnr-img">
                            <span class="lbl">Offres généreuses</span>
                            <img src="assets/img/banner/2.jpg" alt="banner">
                        </div>
                        <div class="gi-bnr-detail">
                            <h5>Pour vous.</h5>
                            <p>Ne passez pas à côté !</p>
                            <a href="shop-left-sidebar-col-3.html" class="gi-btn-2">J’en profite maintenant</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-md-6 wow fadeInRight" data-wow-duration="2s">
                <div class="gi-ofr-banners m-t-767">
                    <div class="gi-bnr-body">
                        <div class="gi-bnr-img">
                            <span class="lbl">Opportunité</span>
                            <img src="assets/img/banner/3.jpg" alt="banner">
                        </div>
                        <div class="gi-bnr-detail">
                            <h5>A saisir</h5>
                            <p>C’est le moment parfait.</p>
                            <a href="shop-left-sidebar-col-3.html" class="gi-btn-2">Je saisis ma chance</a>
                        </div>
                    </div>
                </div>
            </div>
