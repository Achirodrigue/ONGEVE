  ...
  <div class="modal fade" id="devisProduitQtyUpdate{{ $clientdevisprod->id }}" tabindex="-1" aria-labelledby="createAKIKeyModalLabel" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <!-- Body -->
        <form method="post" action="{{ route('commercial.produit.devis.qty.update', $clientdevisprod) }}" enctype="multipart/form-data">
        @csrf
            ...
            <div class="row mb-4">
              ...
              <div class="col-sm">
                ...
                @if($clientdevisprod->clientdevisremise && $clientdevisprod->clientdevisremise->TR)
                  <input type="number" name="remise" value="{{ $clientdevisprod->clientdevisremise->remise }}" id="nom" min="1" max="99" class="form-control" placeholder="Remise sur le produit" required>
                @else
