  ...
  <div class="modal fade" id="editfournisseur{{ $fournisseur->id }}" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
      <div class="modal-content">
        ...
        <form method="post" action="{{ route('commun.fournisseur.update', $fournisseur) }}" enctype="multipart/form-data">
        @csrf
        @method('PATCH')
          <!-- Body -->
          <div class="modal-body">
            ...
            <div class="row mb-4">
              ...
              <div class="col-sm">
                ...
                <input type="text" name="NCC" value="{{ $fournisseur->NCC }}" class="form-control" id="NCC" placeholder="Entrer un NCC" aria-label="Entrer un NCC">
  ...
  <div class="modal fade" id="deletefournisseur{{ $fournisseur->id }}" tabindex="-1" aria-labelledby="createAKIKeyModalLabel" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <!-- Footer -->
        <form action="{{ route('commun.fournisseur.destroy', $fournisseur) }}" method="POST">
        @csrf
        @method('DELETE')
  ...
  <div class="modal fade" id="confirmeCreationFacture{{ $fournisseur->id }}" tabindex="-1" aria-labelledby="createAKIKeyModalLabel" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        <!-- Header -->
        <div class="modal-header">
          <h4 class="modal-title text-danger" id="createAKIKeyModalLabel">Confirmation de création de facture</h4>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <!-- End Header -->
        ...
        <!-- Body -->
        <div class="modal-body">
            <p class="fw-bold mb-0">Voulez-vous vraiment créer une facture pour le fournisseur <span class="text-warning">{{ $fournisseur->nom }}</span> ??</p>
        </div>
        <!-- End Body -->

        <!-- Footer -->
        <form action="{{ route('geststock.fournisseur.confirme.creation.facture', $fournisseur) }}" method="get">
        @csrf
            <div class="modal-footer">
                <div class="row align-items-sm-center flex-grow-1 mx-n2 justify-content-end">
                    <div class="col-sm-auto">
