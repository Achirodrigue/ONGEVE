  <div class="modal fade" id="addtransactioncommande{{ $clientdevis->id }}" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
      <div class="modal-content">
        ...
        <form method="post" action="{{ route('comptable.commande.client.transaction.store', $clientdevis) }}" enctype="multipart/form-data">
        @csrf
          <!-- Body -->
  ...
  <div class="modal fade" id="adddevisbon{{ $clientdevis->id }}" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
      <div class="modal-content">
        ...
        <form method="POST" action="{{ route('comptable.commande.client.add.bon', $clientdevis) }}" enctype="multipart/form-data">
        @csrf
          <!-- Body -->
          <div class="modal-body">
