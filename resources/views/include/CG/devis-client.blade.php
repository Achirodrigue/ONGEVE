          ...
          <div class="modal-body">
            ...
            <div class="row mb-4">
              <div class="col-sm-3 mb-2 mb-sm-0">
                <div class="d-flex align-items-center mt-2">
                  <i class="bi-people nav-icon"></i>
                  <div class="flex-grow-1">@if($clientdevis->clientdevisbon) Nouveau @else Ajouter un @endif bon de commande (facultatif)</div>
                </div>
              </div>
              <div class="col-sm">
                <label for="fichier" class="visually-hidden form-label">@if($clientdevis->clientdevisbon) Nouveau @else Ajouter un @endif bon de commande (facultatif)</label>
