  ...
  <header id="header" class="navbar navbar-expand-lg navbar-fixed navbar-height navbar-container navbar-bordered bg-white">
    <div class="navbar-nav-wrap">
      ...
      <a class="navbar-brand" href="index.html" aria-label="Front">
          <img class="navbar-brand-logo" src="{{ asset("dashboard/assets/svg/logos/logo.svg") }}" alt="Logo" data-hs-theme-appearance="default">
          <img class="navbar-brand-logo" src="{{ asset("dashboard/assets/svg/logos-light/logo.svg") }}" alt="Logo" data-hs-theme-appearance="dark">
          <img class="navbar-brand-logo-mini" src="{{ asset("dashboard/assets/svg/logos/logo-short.svg") }}" alt="Logo" data-hs-theme-appearance="default">
          <img class="navbar-brand-logo-mini" src="{{ asset("dashboard/assets/svg/logos-light/logo-short.svg") }}" alt="Logo" data-hs-theme-appearance="dark">
      </a>
      <!-- End Logo -->
          ...
          <li class="nav-item">
            ...
            <div class="dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-end navbar-dropdown-menu navbar-dropdown-menu-borderless navbar-dropdown-account" aria-labelledby="accountNavbarDropdown" style="width: 16rem;">
                ...
                <div class="dropdown-divider"></div>
                <form action="{{ route('magasinier.logout') }}" method="post">
                @csrf
          ...
          <div id="navbarVerticalMenu" class="nav nav-pills nav-vertical card-navbar-nav">
            ...
            <div class="nav-item">
              ...
              <div id="navbarVerticalMenuDashboards" class="nav-collapse collapse show" data-bs-parent="#navbarVerticalMenu">
                <a class="nav-link @if(Route::currentRouteName() === 'admin.home') active @endif" href="{{ route('admin.home') }}">Default</a>
                <a class="nav-link @if(Route::currentRouteName() === 'admin.homes') active @endif" href="{{ route('admin.homes') }}">Alternative</a>
              </div>
            </div>
            <!-- End Collapse -->
            ...
            <div id="navbarVerticalMenuPagesMenu">
              <!-- Categorie -->
              <div class="nav-item">
                <a  class="nav-link dropdown-toggle @if(Route::currentRouteName() === 'magasinier.categorie.index' or Route::currentRouteName() === 'magasinier.categorie.create' or Route::currentRouteName() === 'magasinier.categorie.edit' or Route::currentRouteName() === 'magasinier.categorie.produit') active @endif" 
                    href="#categorie" role="button" data-bs-toggle="collapse" data-bs-target="#categorie" 
                    aria-expanded="false" aria-controls="categorie">
                  <i class="bi-grid-1x2 nav-icon"></i>
                  <span class="nav-link-title">Categories produit</span>
                </a>

                <div  id="categorie" 
                      class="nav-collapse collapse @if(Route::currentRouteName() === 'magasinier.categorie.index' or Route::currentRouteName() === 'magasinier.categorie.create' or Route::currentRouteName() === 'magasinier.categorie.edit' or Route::currentRouteName() === 'magasinier.categorie.produit') show @endif" 
                      data-bs-parent="#navbarVerticalMenuPagesMenu">
                  <a class="nav-link @if(Route::currentRouteName() === 'magasinier.categorie.index' or Route::currentRouteName() === 'magasinier.categorie.edit' or Route::currentRouteName() === 'magasinier.categorie.produit') active @endif" href="{{ route('magasinier.categorie.index') }}">Les catégories</a>
                  <a class="nav-link @if(Route::currentRouteName() === 'magasinier.categorie.create') active @endif" href="{{ route('magasinier.categorie.create') }}">Ajouter</a>
                </div>
              </div>
              <!-- End Categorie -->
              ...
              <!-- Produit -->
              <div class="nav-item">
                <a  class="nav-link dropdown-toggle @if(Route::currentRouteName() === 'magasinier.produit.index' or Route::currentRouteName() === 'magasinier.produit.create' or Route::currentRouteName() === 'magasinier.produit.edit' or Route::currentRouteName() === 'magasinier.detail.produit') active @endif" 
                ...
                <div  id="produit" 
                      class="nav-collapse collapse @if(Route::currentRouteName() === 'magasinier.produit.index' or Route::currentRouteName() === 'magasinier.produit.create' or Route::currentRouteName() === 'magasinier.produit.edit' or Route::currentRouteName() === 'magasinier.detail.produit') show @endif" 
                      data-bs-parent="#navbarVerticalMenuPagesMenu">
                  <a class="nav-link @if(Route::currentRouteName() === 'magasinier.produit.index' or Route::currentRouteName() === 'magasinier.produit.edit' or Route::currentRouteName() === 'magasinier.detail.produit') active @endif" href="{{ route('magasinier.produit.index') }}">Les produits</a>
                  <a class="nav-link @if(Route::currentRouteName() === 'magasinier.produit.create') active @endif" href="{{ route('magasinier.produit.create') }}">Ajouter</a>
                </div>
              </div>
              <!-- End Produit -->

              <!-- Stock -->
              <span class="dropdown-header mt-2">Layouts</span>
              <!-- <small class="bi-three-dots nav-subtitle-replacer"></small> -->
              <div class="nav-item">
                <a  class="nav-link  @if(Route::currentRouteName() === 'magasinier.stock.global.produit.un' or Route::currentRouteName() === 'magasinier.stock.global.produit.deux') active @endif" 
                    href="{{ route('magasinier.stock.global.produit.un') }}" data-placement="left">
                  <i class="bi-grid-1x2 nav-icon"></i>
              ...
              <div class="nav-item">
                <a  class="nav-link dropdown-toggle @if(Route::currentRouteName() === 'magasinier.stock.global.produit.un' or Route::currentRouteName() === 'magasinier.stock.global.produit.deux') active @endif" 
                ...
                <div  id="stock" 
                      class="nav-collapse collapse @if(Route::currentRouteName() === 'magasinier.stock.global.produit.un' or Route::currentRouteName() === 'magasinier.stock.global.produit.deux') show @endif" 
                      data-bs-parent="#navbarVerticalMenuPagesMenu">
                  <a class="nav-link @if(Route::currentRouteName() === 'magasinier.stock.global.produit.un') active @endif" href="{{ route('magasinier.stock.global.produit.un') }}">Historique</a>
