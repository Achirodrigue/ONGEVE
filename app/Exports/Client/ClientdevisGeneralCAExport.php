...
class ClientdevisGeneralCAExport implements
    FromCollection,
    WithHeadings,
    WithMapping,
    WithEvents,
    ...
    ShouldAutoSize // élargit les colonnes automatiquement
{
    ...
    public function collection()
    {
        ...
        $clientdevis = Clientdevis::whereHas('clientdevisinfo', function ($query) {
                ...
                })->with(['client', 'clientdevisbon', 'Clientdevistransactions'])
    ...
    public function map($clientdevis): array
    {
        ...
        return [
            ...
            $TDF,
            $clientdevis->frais ?? 'Vide',
            $clientdevis->total_ttc ?? '0',
            $clientdevis->airsi_montant ?? '0',
            $clientdevis->timbre_montant ?? '0',
