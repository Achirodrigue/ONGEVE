...
class FournisseurFactureGeneralExport implements
    FromCollection,
    WithHeadings,
    WithMapping,
    WithTitle,
    ...
    ShouldAutoSize // élargit les colonnes automatiquement
{
    ...
    public function collection()
    {
        ...
        $fournisseurfacturecomptable = Fournisseurfacturecomptable::with(['fournisseur', 'fournisseurfcts'])
    ...
    public function map($fournisseurfacturecomptable): array
    {
        ...
        return [
            ...
            $fournisseurfacturecomptable->fournisseur->nom,
    ...
    {
        return 'A9'; // Commence après les infos et le logo
    }
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $sheet->setCellValue('A7', 'Statut des Factures : ' . $statutLabel);
                // $sheet->setCellValue('A7', 'Statut des Factures : ' . ($this->statut == 0 ? "Impayé" : ($this->statut == 1 ? "Finalisé" : "Partiellement Payé")));
                ...
                for ($row = 12; $row < 12 + $this->rowCount; $row++) {
