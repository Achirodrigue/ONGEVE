...
class RessourceDashboardController extends Controller
{
    public function index()
    {
        ...
        return view('dashboard.ressource.ange.dashboard', compact('entretiens'));  // Assure-toi que cette vue existe
    }
}
