...
class AdminPageController extends Controller
{
    ...
    public function logout(Request $request) {
        ...
        // $date = "01-04-2025"; // Date initiale
        // $formattedDate = Carbon::createFromFormat('d-m-Y', $date)->format('j-n-y');

        // echo $formattedDate; // Résultat : 1-4-25
    ...
    public function home()
    {
        ...
        $soldedays = Soldeday::orderBy('id', 'desc')->take(8)->get();
        ...
        return view('dashboard.admin.home', 
                    compact(
                        'soldedays','n','Gsolde',
                        'produits','vendeurs','formations',
                        'commandes','categories','souscategories',
                        'secteurs','livreurs','formateurs',
                        'commandes','categories','equipes',
                    ));
    }
    
    //stock
        public function StockProduitUn()
        {
            $produits = Produit::orderBy('updated_at', 'desc')->get();

            return view('dashboard.admin.historique-stock.stock1', compact('produits'));
        }
        public function StockProduitDeux()
        {
            $prodses = Prodse::orderBy('updated_at', 'desc')->get();

            return view('dashboard.admin.historique-stock.stock2', compact('prodses'));
        }
    //
