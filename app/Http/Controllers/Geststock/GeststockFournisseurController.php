...
class GeststockFournisseurController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('dashboard.geststock.fournisseur.all-fournisseur', compact('fournisseurs'));
    }

    public function create()
    {
        // return view('dashboard.geststock.fournisseur.add-fournisseur');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('geststock.fournisseur.index')->with('success', "$noms ajouté avec succès");
    }

    public function edit(Fournisseur $fournisseur)  
    {
        // return view('dashboard.geststock.fournisseur.edit-fournisseur', compact('fournisseur'));
    }
    ...
    public function update(Request $request, Fournisseur $fournisseur)
    {
        ...
        return redirect()->route('geststock.fournisseur.index')->with('success', "$noms modifié avec succès");
    }
